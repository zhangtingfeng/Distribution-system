...
{
    public partial class ProductClassStyleModel0 : System.Web.UI.Page
    {
        ...
        protected void setLiteral_WeiXinShare()///微信转发首页
        {
            ...
            bool boolAgent = bll_tab_ShopClient_Agent_.Exists("UserID=" + pub_Int_Session_CurUserID + " and (isnull(Empowered, 0) = 1 or OnlyIsAngel=1)" + "   and IsDeleted=0 and ShopClientID=" + pub_Int_ShopClientID);///有代理啊
            if (boolAgent)
            {
