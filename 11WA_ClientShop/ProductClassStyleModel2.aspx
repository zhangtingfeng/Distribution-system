<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductClassStyleModel2.aspx.cs" Inherits="_11WA_ClientShop.ProductClassStyleModel2" %>
    ...
    <script type="text/javascript">
        ...
        function doDefault_SAgent_ProductGood() {
            $.ajax({
                ...
                success: function (msg) {
                    //alert(msg);
                    $("#SAgent_ProductNewGoodClass").html(msg);
                },
                error: function (data) {
                }
            })
