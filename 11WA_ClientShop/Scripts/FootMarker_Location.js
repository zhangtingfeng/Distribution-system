...
function testAsync(longitude, latitude) {
    url_FootMark_Html5_Save_ += "&longitude=" + longitude + "&latitude=" + latitude;
    var url = "https://service.eggsoft.cn/User/FootMark.asmx/_FootMark_Html5_Save?" + url_FootMark_Html5_Save_;
