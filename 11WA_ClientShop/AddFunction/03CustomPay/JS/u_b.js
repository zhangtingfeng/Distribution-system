(function () {
    ...
    w.contains = w.include = function (n, t) {
        return null == n ? !1 : y && n.indexOf === y ? n.indexOf(t) != -1 : E(n,
        function (n) {
            return n === t
        })
    },
    ...
    w.where = function (n, t, r) {
        return w.isEmpty(t) ? r ? null : [] : w[r ? "find" : "filter"](n,
        function (n) {
    ...
    w.template = function (n, t, r) {
        ...
        n.replace(u,
        function (t, r, e, u, o) {
            return a += n.slice(i, o).replace(B,
            function (n) {
                return "\\" + q[n]
            }),
    ...
    h.extend(d.prototype, o, {
        ...
        unset: function (t, e) {
            return this.set(t, void 0, h.extend({},
            e, {
                unset: true
            }))
        },
    ...
    h.extend(g.prototype, o, {
        ...
        add: function (t, e) {
            return this.set(t, h.defaults(e || {},
            y))
        },
        remove: function (t, e) {
    ...
    h.extend(b.prototype, o, {
        ...
        _configure: function (t) {
            if (this.options) t = h.extend({},
            h.result(this, "options"), t);
    ...
    h.extend(S.prototype, o, {
        ...
        _routeToRegExp: function (t) {
            t = t.replace(A, "\\$&").replace($, "(?:$1)?").replace(T,
            function (t, e) {
                return e ? t : "([^/]+)"
            }).replace(H, "(.*?)");
            return new RegExp("^" + t + "$")
