...
{
    public partial class ProductClassStyleModel1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DoHTML();
                    setGoodChildClass();
                    //_Pub_ProductGoodClass_ = Eggsoft_Public_CL.Pub_Agent.strGet_SAgent_ProductGoodClass(pub_Int_Session_CurUserID, pub_Int_ShopClientID, Pub_Agent_Path,0);
        ...
        protected void DoHTML()
        {
            ...
            _Pub_02Topbar_html = strTopbar.Replace("###SAgentPath###", Pub_Agent_Path);
        ...
        protected void setLiteral_WeiXinShare()///微信转发首页
        {
            ...
            pub_WeiXin__o2o_FootMarker_Location___ = Eggsoft_Public_CL.Pub.Get_o2o_script_From_ShopClientID_(pub_Int_Session_CurUserID, strTitle);
