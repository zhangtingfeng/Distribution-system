(function (L) {
    var B = [[]],
        ...
        G = "",
        M = {},
        N = location.href.indexOf("mdebug=1") != -1;
    E.alias = {};
    var F = {},
        d = {},
        c = [];
    B["1"] = ["/Templet/01WYJS/js/StaticGtimgCom/lazyload.201403071104.js", "/Templet/01WYJS/js/StaticGtimgCom/loadscript.201306251923.js", "/Templet/01WYJS/js/StaticGtimgCom/url.201309101641.js", "/Templet/01WYJS/js/StaticGtimgCom/wd.scroll.201405261106.js", "/Templet/01WYJS/js/StaticGtimgCom/zepto.201402121740.js"];
    B["0"] = ["/Templet/01WYJS/js/StaticGtimgCom/wd.shop.global.201405261106.js"];
    ...
    if (typeof (JSON) != "undefined" && window.localStorage) {
        for (var K in localStorage) {
            if (/^_m_/.test(K)) {
                var I = JSON.parse(localStorage.getItem(K));
                var J = K.substr(3);
                if ((new Date()).getTime() > I.cacheTime) {
                    continue
                }
                var C = a(J);
                if (!C || C.group == 0) {
                ...
                var H = B[C.group][C.groupid];
                if ((m + H) == I.path) {
                    B[0].push(H);
                    B[C.group][C.groupid] = G;
                    c[C.index] = [C.id, 0, B[0].length - 1]
                }
            }
        }
    }
    ...
    function p(e) {
        ...
        return b.length > 1 ? (m + "/AddFunction/08Function/HandlerHttpCombiner.ashx?file=" + b.join(",")) : (m + b[0])
    }
    for (var J = 0; J < c.length; J++) {
        var D = m + B[c[J][1]][c[J][2]];
        var g = p(B[c[J][1]]);
        F[c[J][0]] = D;
        d[c[J][0]] = (c[J][1] == 0) ? D : g
    }
...
var modulejs, require, define; (function (global) {
    ...
    function _require(id) {
        ...
        var exports = isType("Function", factory) ? factory(require, module.exports = {},
            module) : factory;
    ...
    function mergeObject(a, b) {
        for (var i in b) {
            ...
            if (!a[i]) {
                ...
                if (Object.prototype.toString.call(b[i]) == "[object Object]") {
                    mergeObject(a[i], b[i])
                } else {
                    a[i] = b[i]
                }
    ...
    function emit(name, evt) {
        ...
        for (var i = 0,
            l = cfg.events[name].length; i < l; i++) {
    ...
    function parseDependencies(code) {
        ...
        var ret = [];
        code.replace(commentRegExp, "").replace(cjsRequireRegExp,
            function (match, dep) {
