...
{
    public partial class ShowAgentBookMark : System.Web.UI.Page
    {
        ...
        private void InitWeiXinShareLink()
        {
            ...
            try
            {
                ...
                string pub_strURL = Eggsoft.Common.Application.AppUrl + Pub_Agent_Path + "/showagentbookmark.aspx";
                ...
                strShareLink = strShareLink.Replace("###_PulicChageWeiXin_Title_Goods###", GetNickName + "代理商代理证书,微商代理证书");
                pub_WeiXin__o2o_FootMarker_Location___ = Eggsoft_Public_CL.Pub.Get_o2o_script_From_ShopClientID_(pub_Int_Session_CurUserID, GetNickName + "代理商代理证书,微商代理证书");
        ...
        private void Image_MarkerErWeiMaThisBook()
        {
            ...
            {
                Eggsoft_Public_CL.Pub_Agent.Pub_Agent_GetAgent_BookMarkerPath(pInt_QueryString_ParentID, out strPath);
            ...
            {
                Eggsoft_Public_CL.Pub_Agent.Pub_Agent_GetAgent_BookMarkerPath(pub_Int_Session_CurUserID, out strPath);
