...
{
    public partial class Wheel : System.Web.UI.Page
    {
        public String strPubAngle = "";
        ...
        private void InitWeiXinShareLink()
        {
            ...
            try
            {
                string pub_strDESFull = "转转车,微信代理分销,朋友圈代理分销,线下批发,代理联营等多种销售模式";
                ...
                pub_str_FirstImageFull = "https://" + Model_tab_ShopClient.ErJiYuMing + "/Huodong/resources/lottery/images/activity-lottery-1_meitu_1.png";
        ...
        private void loadBonus()
        {
            ...
            Localize_ShowBonus.Text += "					</p>\n";
            Localize_ShowBonus.Text += "					<p>\n";
            Localize_ShowBonus.Text += "						幸运奖：杯子 。奖品数量：200\n";
            Localize_ShowBonus.Text += "					</p>\n";
            ...
            string[] strGetLevelList = { "特等奖", "一等奖", "二等奖", "三等奖", "四等奖" };
            int[] intgetNoneLevelList = { 30, 80, 150, 200, 270, 300, 330 };

            if (intlevel > -1)
            {
                strPubAngle = intgetLevelList[intlevel].ToString();
