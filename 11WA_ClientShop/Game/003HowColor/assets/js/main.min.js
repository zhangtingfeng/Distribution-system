...
var _lang = {
    zh: {
        title: "看你有多色",
        help_txt: "双飞吗？7倍赠送.找出所有色块里颜色不同的一个。<br />有朋友在旁边吗？叫她来“双飞”？",
        score: "得分：",
        btn_pause: "暂停",
        btn_normal: "普通场",
        btn_double: "双飞场",
...
shareData = {
    imgUrl: "https://000001shiyidianzi.eggsoft.cn/game/003HowColor/assets/img/find.logo.png?ver=2.1.62",
    //分享时图标地址
    timeLineLink: "https://000001shiyidianzi.eggsoft.cn/game/003HowColor/",
    //分享时的url
    tTitle: "我们的微商城，看你有多色?",
    //分享的标题
...
function () {
    ...
    c = {
        ...
        init: function (a, c, d) {
            this.type = a,
            this.target = "color2" == a ? 2 : 1,
            this.api = API[a],
            this.config = _config[a],
            this.lang = _lang[_config.lang],
            b.mode.data("type", "color" == a ? "color2" : "color").html("color" == a ? this.lang.btn_double : this.lang.btn_normal),
            this.reset(),
            this.parent = d,
            this.el = c,
            this.renderUI(),
        ...
        initEvent: function () {
            ...
            function () {
                ...
                "a" == a && ($(this).css("background-color", "#f00").data("type", "").html("<em></em>"), ++e.finded == e.target && e.nextLv.call(e))
            }),
        ...
        gameOver: function () {
            ...
            testAddAsync(this.score);///大赛
            if (this.lastScore = this.score, this.lastGameTxt = d.txt, this.lastGamePercent = d.percent, b.d_content.hide(), b.d_gameover.show().find("h3").text(this.lastGameTxt), a.find("span").fadeOut(1500,
            function () {
                b.dialog.show()
            }), "color2" == this.type) {
...
function () {
    ...
    e = {
        ...
        render: function (e, f) {
            ...
            var h = this.getColor(255 - this.d),
            i = this.getLvColor(h[0]),
            j = this.getColor(155 - this.d),
            k = this.getLvColor(j[0]),
            l = [],
            m = [];
            a.find(b).each(function (a, b) {
                e / 2 > a % e ? ($(b).css("background-color", h[1]), l.push($(b))) : ($(b).css("background-color", j[1]), m.push($(b)))
            });
            var n = Math.floor(Math.random() * l.length),
            o = Math.floor(Math.random() * m.length);
        ...
        getGameOverText: function (a) {
            var b = 40 > a ? 0 : Math.ceil((a - 40) / 10),
            c = this.lvT[b] || _.last(this.lvT),
            d = c + "，得分" + a,
            e = a;
            return e = 30 > e ? 35 : 70 > e ? 1.14 * (a - 35) + 35 : 80 > a ? .5 * (a - 70) + 75 : 90 > a ? a - 80 + 80 : 100 > a ? a - 90 + 85 : 110 > a ? .02 * (a - 110) + 95 : 120 > a ? .02 * (a - 110) + 97 : 130 > a ? .01 * (a - 120) + 99 : 100,
            e = ("" + e).length > 5 ? e.toFixed(2) : e,
            {
                txt: d,
                percent: e
