...
{
    public partial class DoTask_Services_10SSQ_240 : System.Web.UI.Page
    {

        private static Object myLockSSQ = new object();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                lock (myLockSSQ)
                {
                    ...
                    string strSSQWhere = "Convert(varchar(10),[CreateTime],120) = Convert(varchar(10),getDate(),120) and Name='双色球' and HaoMa is not null and QiShu is not null and (ISUsedEveryDay=0 or ISUsedEveryDay is null)";
                    ...
                    if (BLL_tab_HelpSSQ_3D.Exists(strSSQWhere))
                    {
                        ...
                        string str_ZC_01Product_Support = "select ID,SupportHowMany,ZC_01ProductID,ShopClientID,SourceGoodID  from tab_ZC_01Product_Support where SupportWay=1";
                        ...
                        for (int i = 0; i < DataTableSSQ.Rows.Count; i++)
                        {
                            ...
                            strWherePartnerList += " WHERE   ((tab_ZC_01Product_Support.SupportWay = 1) and (tab_ZC_01Product_PartnerList.GetBonusID is null) and (tab_ZC_01Product_PartnerList.SupportID=" + strSupportID + "))";
                            ...
                            else if (intRowCount >= (Int32.Parse(strSupportHowMany)))
                            {
                                ...
                                string strBonusShow = "";
                                strBonusShow += "微云基石商城开奖期数" + DateTime.Now.ToString("yyyy") + Eggsoft.Common.StringNum.Add000000Num(intGetBonusID, 3) + ",中国福利彩票双色球" + strQiShu + "期开奖结果" + strHaoMa;
                                ...
                                for (int j = 0; j < Int32.Parse(strSupportHowMany); j++)///告诉所有人 中奖结果
                                {
                                    string strSendMsg = "";
            ...
            {
                Response.Redirect("DoTask_Services_10SSQ_240.aspx");
            }
