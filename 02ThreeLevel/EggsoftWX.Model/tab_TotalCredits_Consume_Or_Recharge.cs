...
{
    /// <summary>
    /// 实体类tab_TotalCredits_Consume_Or_Recharge 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tab_TotalCredits_Consume_Or_Recharge
    {
        ...
        {}
        #region Model
        //ID,UserID,ShopClient_ID,UpdateTime,ConsumeOrRechargeType,Bool_ConsumeOrRecharge,ConsumeOrRechargeMoney,ConsumeTypeOrRecharge,RemainingSum,BoolIfOnlyonceUpdate,CreatTime,Creatby,
        private Int32 _ID;
