...
{
    /// <summary>
    /// 实体类tab_TotalBeans_Consume_Or_Recharge 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tab_TotalBeans_Consume_Or_Recharge
    {
        public tab_TotalBeans_Consume_Or_Recharge()
        {}
        #region Model
        //ID,UserID,ShopClient_ID,UpdateTime,ConsumeOrRechargeType,ConsumeOrRechargeBean,ConsumeTypeOrRecharge,RemainingSumBean,Bool_ConsumeOrRecharge,BoolIfOnlyonceUpdate,CreatTime,Creatby,
        private Int32 _ID;
        private Int32? _UserID;
        private Int32? _ShopClient_ID;
        private DateTime? _UpdateTime;
        private Int32? _ConsumeOrRechargeType;
        private Int32? _ConsumeOrRechargeBean;
        private string _ConsumeTypeOrRecharge;
        private Int32? _RemainingSumBean;
        ...
        ///  bigint 长度19 占用字节数8 小数位数0 允许空 默认值无 
        /// </summary>
        public Int32? ConsumeOrRechargeBean
        {
            set{ _ConsumeOrRechargeBean=value;}
            get{return _ConsumeOrRechargeBean;}
        }
        /// <summary>
        ...
        ///  bigint 长度19 占用字节数8 小数位数0 允许空 默认值无 
        /// </summary>
        public Int32? RemainingSumBean
        {
            set{ _RemainingSumBean=value;}
            get{return _RemainingSumBean;}
        }
        /// <summary>
