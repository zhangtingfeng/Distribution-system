...
{
    /// <summary>
    /// 实体类tab_Class2 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tab_Class2
    {
        ...
        {}
        #region Model
        //ID,Class1_ID,ClassName,ClassIcon,Updatetime,Sort,IsShow,IsLock,ShopClientID,CreatTime,BigPicpath,
        private int _ID;
        ...
        /// <summary>
        ///一级分类的ID号 即Class1_ID 外键  int 长度10 占用字节数4 小数位数0 允许空 默认值无 
        /// </summary>
        ...
        /// <summary>
        ///分类说明  nvarchar 长度50 占用字节数100 小数位数0 允许空 默认值无 
        /// </summary>
        ...
        /// <summary>
        ///如何排序  int 长度10 占用字节数4 小数位数0 允许空 默认值无 
        /// </summary>
        public int? Sort
        {
            set{ _Sort=value;}
        ...
        /// <summary>
        ///是否锁定访问  bit 长度1 占用字节数1 小数位数0 允许空 默认值无 
        /// </summary>
        public bool? IsLock
        {
            set{ _IsLock=value;}
