...
{
    /// <summary>
    /// 实体类View_Today_Cheapest_Agent 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class View_Today_Cheapest_Agent
    {
        ...
        {}
        #region Model
        //PromotePrice,Price,ID,ShopClient_ID,isSaled,Name,Icon,ShortInfo,LongInfo,UpdateTime,IsDeleted,CheapPrice,ShenMaShopping,Shopping_Vouchers,IS_Admin_check,UserID,
