...
{
    /// <summary>
    /// 实体类tab_User_Good_History 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tab_User_Good_History
    {
        ...
        {}
        #region Model
        //ID,UserID,GoodID,Parent_UserID,UpdateTime,Count_Visit,GrandParentID,GreatParentID,Type_Visit,OperationID,CreatTime,
        private Int32 _ID;
        ...
        /// <summary>
        ///访问或者分享  nvarchar 长度-1 占用字节数-1 小数位数0 允许空 默认值('Visit') 
        /// </summary>
        ...
        /// <summary>
        ///运营中心ID  bigint 长度19 占用字节数8 小数位数0 允许空 默认值无 
        /// </summary>
