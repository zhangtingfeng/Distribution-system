...
{
    /// <summary>
    /// 数据访问类tab_ShopClient_Agent__ProductClassID。
    /// </summary>
    public class tab_ShopClient_Agent__ProductClassID:Itab_ShopClient_Agent__ProductClassID
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_ShopClient_Agent__ProductClassID]");
       ...
       /// <summary>
		...
		public Int32 Add(EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID model)
		{
			...
			iData[0] = new SqlParameter("@TableName", "tab_ShopClient_Agent__ProductClassID");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_ShopClient_Agent__ProductClassID]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_ShopClient_Agent__ProductClassID] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_ShopClient_Agent__ProductClassID] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_ShopClient_Agent__ProductClassID] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_ShopClient_Agent__ProductClassID] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_ShopClient_Agent__ProductClassID] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_ShopClient_Agent__ProductClassID] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_ShopClient_Agent__ProductClassID] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_ShopClient_Agent__ProductClassID] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		public EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID GetModel(string strWhere, params object[] objs)
		{
			...
			strSql.Append("select * from [tab_ShopClient_Agent__ProductClassID] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID model=new EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["StockNum_MeHavebuyNum"].ToString()!="")
				{
					model.StockNum_MeHavebuyNum=Int32.Parse(ds.Tables[0].Rows[0]["StockNum_MeHavebuyNum"].ToString());
				}
				if(ds.Tables[0].Rows[0]["ProductRightNum"].ToString()!="")
				{
					model.ProductRightNum=Int32.Parse(ds.Tables[0].Rows[0]["ProductRightNum"].ToString());
				}
				if(ds.Tables[0].Rows[0]["Full_Vouchers_"].ToString()!="")
				{
					model.Full_Vouchers_=Convert.ToBoolean(ds.Tables[0].Rows[0]["Full_Vouchers_"].ToString());
				}
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_ShopClient_Agent__ProductClassID] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		public int Update(EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID model)
		{
			...
			if (model.StockNum_MeHavebuyNum != null) strSql.Append("[StockNum_MeHavebuyNum]=@StockNum_MeHavebuyNum,");
			if (model.ProductRightNum != null) strSql.Append("[ProductRightNum]=@ProductRightNum,");
			if (model.Full_Vouchers_ != null) strSql.Append("[Full_Vouchers_]=@Full_Vouchers_,");
			...
			if (model.StockNum_MeHavebuyNum != null) ParameterToArrayList.Add(new SqlParameter("@StockNum_MeHavebuyNum",model.StockNum_MeHavebuyNum));
			if (model.ProductRightNum != null) ParameterToArrayList.Add(new SqlParameter("@ProductRightNum",model.ProductRightNum));
			if (model.Full_Vouchers_ != null) ParameterToArrayList.Add(new SqlParameter("@Full_Vouchers_",model.Full_Vouchers_));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_ShopClient_Agent__ProductClassID]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_ShopClient_Agent__ProductClassID]", strConditions, orderField, isDesc,ParameterToList);
        }
