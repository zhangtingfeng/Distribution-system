...
{
    /// <summary>
    /// 数据访问类tab_ShopClient_Shopping_VouchersScheme_Detail。
    /// </summary>
    public class tab_ShopClient_Shopping_VouchersScheme_Detail:Itab_ShopClient_Shopping_VouchersScheme_Detail
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_ShopClient_Shopping_VouchersScheme_Detail]");
       ...
       /// <summary>
		...
		public Int32 Add(EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail model)
		{
			...
			iData[0] = new SqlParameter("@TableName", "tab_ShopClient_Shopping_VouchersScheme_Detail");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_ShopClient_Shopping_VouchersScheme_Detail]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_ShopClient_Shopping_VouchersScheme_Detail] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_ShopClient_Shopping_VouchersScheme_Detail] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_ShopClient_Shopping_VouchersScheme_Detail] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_ShopClient_Shopping_VouchersScheme_Detail] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_ShopClient_Shopping_VouchersScheme_Detail] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_ShopClient_Shopping_VouchersScheme_Detail] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_ShopClient_Shopping_VouchersScheme_Detail] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_ShopClient_Shopping_VouchersScheme_Detail] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		public EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail GetModel(string strWhere, params object[] objs)
		{
			...
			strSql.Append("select * from [tab_ShopClient_Shopping_VouchersScheme_Detail] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail model=new EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["Scheme_ID"].ToString()!="")
				{
					model.Scheme_ID=Int32.Parse(ds.Tables[0].Rows[0]["Scheme_ID"].ToString());
				}
				model.VouchersNum=ds.Tables[0].Rows[0]["VouchersNum"].ToString();
				if(ds.Tables[0].Rows[0]["GuWuCheIDOrOrderDetailID"].ToString()!="")
				{
					model.GuWuCheIDOrOrderDetailID=Int32.Parse(ds.Tables[0].Rows[0]["GuWuCheIDOrOrderDetailID"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["UserID_Old"].ToString()!="")
				{
					model.UserID_Old=Int32.Parse(ds.Tables[0].Rows[0]["UserID_Old"].ToString());
				}
				if(ds.Tables[0].Rows[0]["Money"].ToString()!="")
				{
					model.Money=decimal.Parse(ds.Tables[0].Rows[0]["Money"].ToString());
				}
				if(ds.Tables[0].Rows[0]["MoneyUsed"].ToString()!="")
				{
					model.MoneyUsed=decimal.Parse(ds.Tables[0].Rows[0]["MoneyUsed"].ToString());
				}
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_ShopClient_Shopping_VouchersScheme_Detail] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
				DbHelperSQL.ExecuteSql(strSql.ToString(),ParameterToList);
		}
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ShopClient_Shopping_VouchersScheme_Detail] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		public void Update(EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail model)
		{
			...
			if (model.Scheme_ID != null) strSql.Append("[Scheme_ID]=@Scheme_ID,");
			if (String.IsNullOrEmpty(model.VouchersNum) == false) strSql.Append("[VouchersNum]=@VouchersNum,");
			if (model.GuWuCheIDOrOrderDetailID != null) strSql.Append("[GuWuCheIDOrOrderDetailID]=@GuWuCheIDOrOrderDetailID,");
			if (model.ShopClientID != null) strSql.Append("[ShopClientID]=@ShopClientID,");
			if (model.UserID != null) strSql.Append("[UserID]=@UserID,");
			if (model.UserID_Old != null) strSql.Append("[UserID_Old]=@UserID_Old,");
			if (model.Money != null) strSql.Append("[Money]=@Money,");
			if (model.MoneyUsed != null) strSql.Append("[MoneyUsed]=@MoneyUsed,");
			...
			if (model.Scheme_ID != null) ParameterToArrayList.Add(new SqlParameter("@Scheme_ID",model.Scheme_ID));
			if (String.IsNullOrEmpty(model.VouchersNum) == false) ParameterToArrayList.Add(new SqlParameter("@VouchersNum",model.VouchersNum));
			if (model.GuWuCheIDOrOrderDetailID != null) ParameterToArrayList.Add(new SqlParameter("@GuWuCheIDOrOrderDetailID",model.GuWuCheIDOrOrderDetailID));
			...
			if (model.UserID_Old != null) ParameterToArrayList.Add(new SqlParameter("@UserID_Old",model.UserID_Old));
			if (model.Money != null) ParameterToArrayList.Add(new SqlParameter("@Money",model.Money));
			if (model.MoneyUsed != null) ParameterToArrayList.Add(new SqlParameter("@MoneyUsed",model.MoneyUsed));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_ShopClient_Shopping_VouchersScheme_Detail]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_ShopClient_Shopping_VouchersScheme_Detail]", strConditions, orderField, isDesc,ParameterToList);
        }
