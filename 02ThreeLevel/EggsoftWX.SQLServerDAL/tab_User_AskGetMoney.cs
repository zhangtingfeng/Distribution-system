...
{
    /// <summary>
    /// 数据访问类tab_User_AskGetMoney。
    /// </summary>
    public class tab_User_AskGetMoney:Itab_User_AskGetMoney
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_User_AskGetMoney]");
        ...
        /// 增加一条数据 model
        /// </summary>
        public Int32 Add(EggsoftWX.Model.tab_User_AskGetMoney model)
        {
            IDataParameter[] iData = new SqlParameter[2];
            iData[0] = new SqlParameter("@TableName", "tab_User_AskGetMoney");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_User_AskGetMoney]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_User_AskGetMoney] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_User_AskGetMoney] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_User_AskGetMoney] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_User_AskGetMoney] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_User_AskGetMoney] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_User_AskGetMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_User_AskGetMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_User_AskGetMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.tab_User_AskGetMoney GetModel(string strWhere, params object[] objs)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [tab_User_AskGetMoney] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_User_AskGetMoney model=new EggsoftWX.Model.tab_User_AskGetMoney();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				model.payment_no=ds.Tables[0].Rows[0]["payment_no"].ToString();
				model.CardName=ds.Tables[0].Rows[0]["CardName"].ToString();
				if(ds.Tables[0].Rows[0]["AskMoney"].ToString()!="")
				{
					model.AskMoney=decimal.Parse(ds.Tables[0].Rows[0]["AskMoney"].ToString());
				}
				model.AskMemo=ds.Tables[0].Rows[0]["AskMemo"].ToString();
				if(ds.Tables[0].Rows[0]["UserID"].ToString()!="")
				{
					model.UserID=Int32.Parse(ds.Tables[0].Rows[0]["UserID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["IFSendMoney"].ToString()!="")
				{
					model.IFSendMoney=Convert.ToBoolean(ds.Tables[0].Rows[0]["IFSendMoney"].ToString());
				}
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.tab_User_AskGetMoney GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_User_AskGetMoney] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_User_AskGetMoney] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_User_AskGetMoney model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_User_AskGetMoney] set ");
			...
			if (String.IsNullOrEmpty(model.payment_no) == false) strSql.Append("[payment_no]=@payment_no,");
			if (String.IsNullOrEmpty(model.CardName) == false) strSql.Append("[CardName]=@CardName,");
			if (model.AskMoney != null) strSql.Append("[AskMoney]=@AskMoney,");
			if (String.IsNullOrEmpty(model.AskMemo) == false) strSql.Append("[AskMemo]=@AskMemo,");
			if (model.UserID != null) strSql.Append("[UserID]=@UserID,");
			if (model.IFSendMoney != null) strSql.Append("[IFSendMoney]=@IFSendMoney,");
			if (String.IsNullOrEmpty(model.ResultCode) == false) strSql.Append("[ResultCode]=@ResultCode,");
			...
			if (String.IsNullOrEmpty(model.payment_no) == false) ParameterToArrayList.Add(new SqlParameter("@payment_no",model.payment_no));
			if (String.IsNullOrEmpty(model.CardName) == false) ParameterToArrayList.Add(new SqlParameter("@CardName",model.CardName));
			if (model.AskMoney != null) ParameterToArrayList.Add(new SqlParameter("@AskMoney",model.AskMoney));
			if (String.IsNullOrEmpty(model.AskMemo) == false) ParameterToArrayList.Add(new SqlParameter("@AskMemo",model.AskMemo));
			if (model.UserID != null) ParameterToArrayList.Add(new SqlParameter("@UserID",model.UserID));
			if (model.IFSendMoney != null) ParameterToArrayList.Add(new SqlParameter("@IFSendMoney",model.IFSendMoney));
			if (String.IsNullOrEmpty(model.ResultCode) == false) ParameterToArrayList.Add(new SqlParameter("@ResultCode",model.ResultCode));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_User_AskGetMoney]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_User_AskGetMoney]", strConditions, orderField, isDesc,ParameterToList);
        }
