...
{
    /// <summary>
    /// 数据访问类tab_ZC_01Product_Support。
    /// </summary>
    public class tab_ZC_01Product_Support:Itab_ZC_01Product_Support
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_ZC_01Product_Support]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_ZC_01Product_Support model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "tab_ZC_01Product_Support");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_ZC_01Product_Support]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_ZC_01Product_Support] where 1>0 "+strWhere+" ");
			object obj=DbHelperSQL.GetSingle(strSql.ToString());
			Int32 cmdresult;
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_ZC_01Product_Support] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_ZC_01Product_Support] where 1>0 "+strWhere+" ");
			object obj=DbHelperSQL.GetSingle(strSql.ToString());
			Int32 cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
			{
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_ZC_01Product_Support] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_ZC_01Product_Support] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_ZC_01Product_Support] where 1>0 " + strWhere);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_ZC_01Product_Support] where 1>0 " + strWhere);
            return DbHelperSQL.GetList(strSql.ToString());
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_ZC_01Product_Support] where 1>0 " + strWhere);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.tab_ZC_01Product_Support GetModel(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [tab_ZC_01Product_Support] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_ZC_01Product_Support model=new EggsoftWX.Model.tab_ZC_01Product_Support();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["SalesLimit"].ToString()!="")
				{
					model.SalesLimit=Int32.Parse(ds.Tables[0].Rows[0]["SalesLimit"].ToString());
				}
				model.SalesPricePromiseAndReturn=ds.Tables[0].Rows[0]["SalesPricePromiseAndReturn"].ToString();
				...
				if(ds.Tables[0].Rows[0]["SupportWay"].ToString()!="")
				{
					model.SupportWay=Int32.Parse(ds.Tables[0].Rows[0]["SupportWay"].ToString());
				}
				if(ds.Tables[0].Rows[0]["SupportHowMany"].ToString()!="")
				{
					model.SupportHowMany=Int32.Parse(ds.Tables[0].Rows[0]["SupportHowMany"].ToString());
				}
				if(ds.Tables[0].Rows[0]["MustSubscribe"].ToString()!="")
				{
					model.MustSubscribe=Convert.ToBoolean(ds.Tables[0].Rows[0]["MustSubscribe"].ToString());
				}
				if(ds.Tables[0].Rows[0]["MustAddress"].ToString()!="")
				{
					model.MustAddress=Convert.ToBoolean(ds.Tables[0].Rows[0]["MustAddress"].ToString());
				}
				if(ds.Tables[0].Rows[0]["OnlyBuyOneOnlyOneAccount"].ToString()!="")
				{
					model.OnlyBuyOneOnlyOneAccount=Convert.ToBoolean(ds.Tables[0].Rows[0]["OnlyBuyOneOnlyOneAccount"].ToString());
				}
				return model;
			}
			else
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.tab_ZC_01Product_Support GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_ZC_01Product_Support] ");
				strSql.Append(" where "+strWhere);
				DbHelperSQL.ExecuteSql(strSql.ToString());
		}
       #endregion
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ZC_01Product_Support] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
			DbHelperSQL.ExecuteSql(strSql.ToString());
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public void Update(EggsoftWX.Model.tab_ZC_01Product_Support model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ZC_01Product_Support] set ");
			...
			if (model.SalesPrice != null) strSql.Append("[SalesPrice]=@SalesPrice,");
			if (model.AgentPrice != null) strSql.Append("[AgentPrice]=@AgentPrice,");
			if (model.SalesLimit != null) strSql.Append("[SalesLimit]=@SalesLimit,");
			if (String.IsNullOrEmpty(model.SalesPricePromiseAndReturn) == false) strSql.Append("[SalesPricePromiseAndReturn]=@SalesPricePromiseAndReturn,");
			...
			if (model.SupportWay != null) strSql.Append("[SupportWay]=@SupportWay,");
			if (model.SupportHowMany != null) strSql.Append("[SupportHowMany]=@SupportHowMany,");
			if (model.MustSubscribe != null) strSql.Append("[MustSubscribe]=@MustSubscribe,");
			if (model.MustAddress != null) strSql.Append("[MustAddress]=@MustAddress,");
			if (model.OnlyBuyOneOnlyOneAccount != null) strSql.Append("[OnlyBuyOneOnlyOneAccount]=@OnlyBuyOneOnlyOneAccount,");
			...
			if (model.SalesPrice != null) ParameterToArrayList.Add(new SqlParameter("@SalesPrice",model.SalesPrice));
			if (model.AgentPrice != null) ParameterToArrayList.Add(new SqlParameter("@AgentPrice",model.AgentPrice));
			if (model.SalesLimit != null) ParameterToArrayList.Add(new SqlParameter("@SalesLimit",model.SalesLimit));
			if (String.IsNullOrEmpty(model.SalesPricePromiseAndReturn) == false) ParameterToArrayList.Add(new SqlParameter("@SalesPricePromiseAndReturn",model.SalesPricePromiseAndReturn));
			...
			if (model.SupportWay != null) ParameterToArrayList.Add(new SqlParameter("@SupportWay",model.SupportWay));
			if (model.SupportHowMany != null) ParameterToArrayList.Add(new SqlParameter("@SupportHowMany",model.SupportHowMany));
			if (model.MustSubscribe != null) ParameterToArrayList.Add(new SqlParameter("@MustSubscribe",model.MustSubscribe));
			if (model.MustAddress != null) ParameterToArrayList.Add(new SqlParameter("@MustAddress",model.MustAddress));
			if (model.OnlyBuyOneOnlyOneAccount != null) ParameterToArrayList.Add(new SqlParameter("@OnlyBuyOneOnlyOneAccount",model.OnlyBuyOneOnlyOneAccount));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere)
       {
           ...
           strSql.Append(" FROM   [tab_ZC_01Product_Support]  where 1 > 0 " + strWhere);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc)
        {
           ...
           if ((strConditions.IndexOf("and") == -1) && (strConditions!="")) strConditions = "and " + strConditions;
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_ZC_01Product_Support]", strConditions, orderField, isDesc);
        }
