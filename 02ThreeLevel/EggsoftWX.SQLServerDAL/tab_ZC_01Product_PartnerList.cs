...
{
    /// <summary>
    /// 数据访问类tab_ZC_01Product_PartnerList。
    /// </summary>
    public class tab_ZC_01Product_PartnerList:Itab_ZC_01Product_PartnerList
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_ZC_01Product_PartnerList]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_ZC_01Product_PartnerList model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "tab_ZC_01Product_PartnerList");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_ZC_01Product_PartnerList]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_ZC_01Product_PartnerList] where 1>0 "+strWhere+" ");
			object obj=DbHelperSQL.GetSingle(strSql.ToString());
			Int32 cmdresult;
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_ZC_01Product_PartnerList] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_ZC_01Product_PartnerList] where 1>0 "+strWhere+" ");
			object obj=DbHelperSQL.GetSingle(strSql.ToString());
			Int32 cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
			{
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_ZC_01Product_PartnerList] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_ZC_01Product_PartnerList] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_ZC_01Product_PartnerList] where 1>0 " + strWhere);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_ZC_01Product_PartnerList] where 1>0 " + strWhere);
            return DbHelperSQL.GetList(strSql.ToString());
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_ZC_01Product_PartnerList] where 1>0 " + strWhere);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.tab_ZC_01Product_PartnerList GetModel(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [tab_ZC_01Product_PartnerList] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_ZC_01Product_PartnerList model=new EggsoftWX.Model.tab_ZC_01Product_PartnerList();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["ZC_01ProductID"].ToString()!="")
				{
					model.ZC_01ProductID=Int32.Parse(ds.Tables[0].Rows[0]["ZC_01ProductID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["SupportID"].ToString()!="")
				{
					model.SupportID=Int32.Parse(ds.Tables[0].Rows[0]["SupportID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["PayPrice"].ToString()!="")
				{
					model.PayPrice=decimal.Parse(ds.Tables[0].Rows[0]["PayPrice"].ToString());
				}
				model.ZCBuysSay=ds.Tables[0].Rows[0]["ZCBuysSay"].ToString();
				if(ds.Tables[0].Rows[0]["Ispay"].ToString()!="")
				{
					model.Ispay=Convert.ToBoolean(ds.Tables[0].Rows[0]["Ispay"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["Credentials"].ToString()!="")
				{
					model.Credentials=Int32.Parse(ds.Tables[0].Rows[0]["Credentials"].ToString());
				}
				if(ds.Tables[0].Rows[0]["IsCanSendGoods"].ToString()!="")
				{
					model.IsCanSendGoods=Convert.ToBoolean(ds.Tables[0].Rows[0]["IsCanSendGoods"].ToString());
				}
				if(ds.Tables[0].Rows[0]["GetBonusID"].ToString()!="")
				{
					model.GetBonusID=Int32.Parse(ds.Tables[0].Rows[0]["GetBonusID"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["GetGoodsAddress"].ToString()!="")
				{
					model.GetGoodsAddress=Int32.Parse(ds.Tables[0].Rows[0]["GetGoodsAddress"].ToString());
				}
				return model;
			}
			else
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.tab_ZC_01Product_PartnerList GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_ZC_01Product_PartnerList] ");
				strSql.Append(" where "+strWhere);
				DbHelperSQL.ExecuteSql(strSql.ToString());
		}
       #endregion
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ZC_01Product_PartnerList] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
			DbHelperSQL.ExecuteSql(strSql.ToString());
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public void Update(EggsoftWX.Model.tab_ZC_01Product_PartnerList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ZC_01Product_PartnerList] set ");
			if (model.ID != null) strSql.Append("[ID]=@ID,");
			if (model.ZC_01ProductID != null) strSql.Append("[ZC_01ProductID]=@ZC_01ProductID,");
			if (model.SupportID != null) strSql.Append("[SupportID]=@SupportID,");
			if (model.PayPrice != null) strSql.Append("[PayPrice]=@PayPrice,");
			if (String.IsNullOrEmpty(model.ZCBuysSay) == false) strSql.Append("[ZCBuysSay]=@ZCBuysSay,");
			if (model.Ispay != null) strSql.Append("[Ispay]=@Ispay,");
			if ((model.PayTime != null)&&(model.PayTime != DateTime.MinValue)) strSql.Append("[PayTime]=@PayTime,");
			if (model.OrderID != null) strSql.Append("[OrderID]=@OrderID,");
			if (model.Credentials != null) strSql.Append("[Credentials]=@Credentials,");
			if (model.IsCanSendGoods != null) strSql.Append("[IsCanSendGoods]=@IsCanSendGoods,");
			if (model.GetBonusID != null) strSql.Append("[GetBonusID]=@GetBonusID,");
			...
			if (model.GetGoodsAddress != null) strSql.Append("[GetGoodsAddress]=@GetGoodsAddress,");
			...
			if (model.ZC_01ProductID != null) ParameterToArrayList.Add(new SqlParameter("@ZC_01ProductID",model.ZC_01ProductID));
			if (model.SupportID != null) ParameterToArrayList.Add(new SqlParameter("@SupportID",model.SupportID));
			if (model.PayPrice != null) ParameterToArrayList.Add(new SqlParameter("@PayPrice",model.PayPrice));
			if (String.IsNullOrEmpty(model.ZCBuysSay) == false) ParameterToArrayList.Add(new SqlParameter("@ZCBuysSay",model.ZCBuysSay));
			if (model.Ispay != null) ParameterToArrayList.Add(new SqlParameter("@Ispay",model.Ispay));
			if ((model.PayTime != null)&&(model.PayTime != DateTime.MinValue)) ParameterToArrayList.Add(new SqlParameter("@PayTime",model.PayTime));
			if (model.OrderID != null) ParameterToArrayList.Add(new SqlParameter("@OrderID",model.OrderID));
			if (model.Credentials != null) ParameterToArrayList.Add(new SqlParameter("@Credentials",model.Credentials));
			if (model.IsCanSendGoods != null) ParameterToArrayList.Add(new SqlParameter("@IsCanSendGoods",model.IsCanSendGoods));
			if (model.GetBonusID != null) ParameterToArrayList.Add(new SqlParameter("@GetBonusID",model.GetBonusID));
			...
			if (model.GetGoodsAddress != null) ParameterToArrayList.Add(new SqlParameter("@GetGoodsAddress",model.GetGoodsAddress));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere)
       {
           ...
           strSql.Append(" FROM   [tab_ZC_01Product_PartnerList]  where 1 > 0 " + strWhere);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc)
        {
           ...
           if ((strConditions.IndexOf("and") == -1) && (strConditions!="")) strConditions = "and " + strConditions;
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_ZC_01Product_PartnerList]", strConditions, orderField, isDesc);
        }
