...
{
    /// <summary>
    /// 数据访问类tab_ShopClient_Agent_。
    /// </summary>
    public class tab_ShopClient_Agent_:Itab_ShopClient_Agent_
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_ShopClient_Agent_]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_ShopClient_Agent_ model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "tab_ShopClient_Agent_");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_ShopClient_Agent_]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_ShopClient_Agent_] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_ShopClient_Agent_] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_ShopClient_Agent_] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_ShopClient_Agent_] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_ShopClient_Agent_] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_ShopClient_Agent_] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_ShopClient_Agent_] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_ShopClient_Agent_] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.tab_ShopClient_Agent_ GetModel(string strWhere, params object[] objs)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [tab_ShopClient_Agent_] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_ShopClient_Agent_ model=new EggsoftWX.Model.tab_ShopClient_Agent_();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["ShopTeamID"].ToString()!="")
				{
					model.ShopTeamID=Int32.Parse(ds.Tables[0].Rows[0]["ShopTeamID"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["OnlyIsAngel"].ToString()!="")
				{
					model.OnlyIsAngel=Convert.ToBoolean(ds.Tables[0].Rows[0]["OnlyIsAngel"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["TeamParentID"].ToString()!="")
				{
					model.TeamParentID=Int32.Parse(ds.Tables[0].Rows[0]["TeamParentID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["Vouchers_Consume_Or_Recharge"].ToString()!="")
				{
					model.Vouchers_Consume_Or_Recharge=decimal.Parse(ds.Tables[0].Rows[0]["Vouchers_Consume_Or_Recharge"].ToString());
				}
				model.AddExp0=ds.Tables[0].Rows[0]["AddExp0"].ToString();
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.tab_ShopClient_Agent_ GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_ShopClient_Agent_] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ShopClient_Agent_] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_ShopClient_Agent_ model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_ShopClient_Agent_] set ");
			if (model.ID != null) strSql.Append("[ID]=@ID,");
			if (model.ShopClientID != null) strSql.Append("[ShopClientID]=@ShopClientID,");
			if (model.ShopTeamID != null) strSql.Append("[ShopTeamID]=@ShopTeamID,");
			if (model.UserID != null) strSql.Append("[UserID]=@UserID,");
			if (String.IsNullOrEmpty(model.ShopName) == false) strSql.Append("[ShopName]=@ShopName,");
			if (model.ParentID != null) strSql.Append("[ParentID]=@ParentID,");
			if (model.OnlyIsAngel != null) strSql.Append("[OnlyIsAngel]=@OnlyIsAngel,");
			if (model.Empowered != null) strSql.Append("[Empowered]=@Empowered,");
			if (model.AgentLevelSelect != null) strSql.Append("[AgentLevelSelect]=@AgentLevelSelect,");
			if (model.TeamParentID != null) strSql.Append("[TeamParentID]=@TeamParentID,");
			if (model.Vouchers_Consume_Or_Recharge != null) strSql.Append("[Vouchers_Consume_Or_Recharge]=@Vouchers_Consume_Or_Recharge,");
			if (String.IsNullOrEmpty(model.AddExp0) == false) strSql.Append("[AddExp0]=@AddExp0,");
			...
			if (model.ShopTeamID != null) ParameterToArrayList.Add(new SqlParameter("@ShopTeamID",model.ShopTeamID));
			if (model.UserID != null) ParameterToArrayList.Add(new SqlParameter("@UserID",model.UserID));
			if (String.IsNullOrEmpty(model.ShopName) == false) ParameterToArrayList.Add(new SqlParameter("@ShopName",model.ShopName));
			if (model.ParentID != null) ParameterToArrayList.Add(new SqlParameter("@ParentID",model.ParentID));
			if (model.OnlyIsAngel != null) ParameterToArrayList.Add(new SqlParameter("@OnlyIsAngel",model.OnlyIsAngel));
			if (model.Empowered != null) ParameterToArrayList.Add(new SqlParameter("@Empowered",model.Empowered));
			if (model.AgentLevelSelect != null) ParameterToArrayList.Add(new SqlParameter("@AgentLevelSelect",model.AgentLevelSelect));
			if (model.TeamParentID != null) ParameterToArrayList.Add(new SqlParameter("@TeamParentID",model.TeamParentID));
			if (model.Vouchers_Consume_Or_Recharge != null) ParameterToArrayList.Add(new SqlParameter("@Vouchers_Consume_Or_Recharge",model.Vouchers_Consume_Or_Recharge));
			if (String.IsNullOrEmpty(model.AddExp0) == false) ParameterToArrayList.Add(new SqlParameter("@AddExp0",model.AddExp0));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_ShopClient_Agent_]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_ShopClient_Agent_]", strConditions, orderField, isDesc,ParameterToList);
        }
