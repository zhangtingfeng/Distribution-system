...
{
    /// <summary>
    /// 数据访问类b018Help_01XianChangHuoDong_UserShake。
    /// </summary>
    public class b018Help_01XianChangHuoDong_UserShake:Ib018Help_01XianChangHuoDong_UserShake
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [b018Help_01XianChangHuoDong_UserShake]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "b018Help_01XianChangHuoDong_UserShake");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [b018Help_01XianChangHuoDong_UserShake]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [b018Help_01XianChangHuoDong_UserShake] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [b018Help_01XianChangHuoDong_UserShake] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [b018Help_01XianChangHuoDong_UserShake] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [b018Help_01XianChangHuoDong_UserShake] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [b018Help_01XianChangHuoDong_UserShake] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [b018Help_01XianChangHuoDong_UserShake] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [b018Help_01XianChangHuoDong_UserShake] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [b018Help_01XianChangHuoDong_UserShake] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake GetModel(string strWhere, params object[] objs)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [b018Help_01XianChangHuoDong_UserShake] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake model=new EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				model.UserIDNickName=ds.Tables[0].Rows[0]["UserIDNickName"].ToString();
				model.UserIDHeadURL=ds.Tables[0].Rows[0]["UserIDHeadURL"].ToString();
				model.UserIDWeiXinHeadURL=ds.Tables[0].Rows[0]["UserIDWeiXinHeadURL"].ToString();
				...
				if(ds.Tables[0].Rows[0]["ThisScore"].ToString()!="")
				{
					model.ThisScore=decimal.Parse(ds.Tables[0].Rows[0]["ThisScore"].ToString());
				}
				if(ds.Tables[0].Rows[0]["ThisAllScoreShakeCount"].ToString()!="")
				{
					model.ThisAllScoreShakeCount=Int32.Parse(ds.Tables[0].Rows[0]["ThisAllScoreShakeCount"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["isDoing"].ToString()!="")
				{
					model.isDoing=Convert.ToBoolean(ds.Tables[0].Rows[0]["isDoing"].ToString());
				}
				if(ds.Tables[0].Rows[0]["isReturnedToBigScreenHeadIMG"].ToString()!="")
				{
					model.isReturnedToBigScreenHeadIMG=Convert.ToBoolean(ds.Tables[0].Rows[0]["isReturnedToBigScreenHeadIMG"].ToString());
				}
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [b018Help_01XianChangHuoDong_UserShake] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [b018Help_01XianChangHuoDong_UserShake] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.b018Help_01XianChangHuoDong_UserShake model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [b018Help_01XianChangHuoDong_UserShake] set ");
			...
			if (String.IsNullOrEmpty(model.UserIDNickName) == false) strSql.Append("[UserIDNickName]=@UserIDNickName,");
			if (String.IsNullOrEmpty(model.UserIDHeadURL) == false) strSql.Append("[UserIDHeadURL]=@UserIDHeadURL,");
			if (String.IsNullOrEmpty(model.UserIDWeiXinHeadURL) == false) strSql.Append("[UserIDWeiXinHeadURL]=@UserIDWeiXinHeadURL,");
			if (model.XianChangHuoDongNum != null) strSql.Append("[XianChangHuoDongNum]=@XianChangHuoDongNum,");
			if (model.ThisScore != null) strSql.Append("[ThisScore]=@ThisScore,");
			if (model.ThisAllScoreShakeCount != null) strSql.Append("[ThisAllScoreShakeCount]=@ThisAllScoreShakeCount,");
			...
			if (model.isDoing != null) strSql.Append("[isDoing]=@isDoing,");
			if (model.isReturnedToBigScreenHeadIMG != null) strSql.Append("[isReturnedToBigScreenHeadIMG]=@isReturnedToBigScreenHeadIMG,");
			if (String.IsNullOrEmpty(model.UserIP) == false) strSql.Append("[UserIP]=@UserIP,");
			...
			if (String.IsNullOrEmpty(model.UserIDNickName) == false) ParameterToArrayList.Add(new SqlParameter("@UserIDNickName",model.UserIDNickName));
			if (String.IsNullOrEmpty(model.UserIDHeadURL) == false) ParameterToArrayList.Add(new SqlParameter("@UserIDHeadURL",model.UserIDHeadURL));
			if (String.IsNullOrEmpty(model.UserIDWeiXinHeadURL) == false) ParameterToArrayList.Add(new SqlParameter("@UserIDWeiXinHeadURL",model.UserIDWeiXinHeadURL));
			...
			if (model.ThisScore != null) ParameterToArrayList.Add(new SqlParameter("@ThisScore",model.ThisScore));
			if (model.ThisAllScoreShakeCount != null) ParameterToArrayList.Add(new SqlParameter("@ThisAllScoreShakeCount",model.ThisAllScoreShakeCount));
			...
			if (model.isDoing != null) ParameterToArrayList.Add(new SqlParameter("@isDoing",model.isDoing));
			if (model.isReturnedToBigScreenHeadIMG != null) ParameterToArrayList.Add(new SqlParameter("@isReturnedToBigScreenHeadIMG",model.isReturnedToBigScreenHeadIMG));
			if (String.IsNullOrEmpty(model.UserIP) == false) ParameterToArrayList.Add(new SqlParameter("@UserIP",model.UserIP));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [b018Help_01XianChangHuoDong_UserShake]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[b018Help_01XianChangHuoDong_UserShake]", strConditions, orderField, isDesc,ParameterToList);
        }
