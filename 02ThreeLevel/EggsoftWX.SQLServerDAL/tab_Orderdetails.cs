...
{
    /// <summary>
    /// 数据访问类tab_Orderdetails。
    /// </summary>
    public class tab_Orderdetails:Itab_Orderdetails
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_Orderdetails]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_Orderdetails model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "tab_Orderdetails");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_Orderdetails]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_Orderdetails] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_Orderdetails] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [tab_Orderdetails] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_Orderdetails] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_Orderdetails] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_Orderdetails] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_Orderdetails] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_Orderdetails] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.tab_Orderdetails GetModel(string strWhere, params object[] objs)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [tab_Orderdetails] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.tab_Orderdetails model=new EggsoftWX.Model.tab_Orderdetails();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				{
					model.Discount=float.Parse(ds.Tables[0].Rows[0]["Discount"].ToString());
				}
				model.GoodName=ds.Tables[0].Rows[0]["GoodName"].ToString();
				if(ds.Tables[0].Rows[0]["GoodPrice"].ToString()!="")
				{
				...
				model.Pinglun=ds.Tables[0].Rows[0]["Pinglun"].ToString();
				...
				if(ds.Tables[0].Rows[0]["Over7DaysToBeans"].ToString()!="")
				{
					model.Over7DaysToBeans=Convert.ToBoolean(ds.Tables[0].Rows[0]["Over7DaysToBeans"].ToString());
				}
				model.VouchersNum_List=ds.Tables[0].Rows[0]["VouchersNum_List"].ToString();
				if(ds.Tables[0].Rows[0]["Beans"].ToString()!="")
				{
					model.Beans=Int32.Parse(ds.Tables[0].Rows[0]["Beans"].ToString());
				}
				if(ds.Tables[0].Rows[0]["MoneyCredits"].ToString()!="")
				{
					model.MoneyCredits=decimal.Parse(ds.Tables[0].Rows[0]["MoneyCredits"].ToString());
				}
				if(ds.Tables[0].Rows[0]["MoneyWeBuy8Credits"].ToString()!="")
				{
					model.MoneyWeBuy8Credits=decimal.Parse(ds.Tables[0].Rows[0]["MoneyWeBuy8Credits"].ToString());
				}
				...
				{
					model.GoodType=Int32.Parse(ds.Tables[0].Rows[0]["GoodType"].ToString());
				}
				if(ds.Tables[0].Rows[0]["GoodTypeId"].ToString()!="")
				{
					model.GoodTypeId=Int32.Parse(ds.Tables[0].Rows[0]["GoodTypeId"].ToString());
				}
				model.GoodTypeIdBuyInfo=ds.Tables[0].Rows[0]["GoodTypeIdBuyInfo"].ToString();
				if(ds.Tables[0].Rows[0]["CreatDateTime"].ToString()!="")
				{
					model.CreatDateTime=DateTime.Parse(ds.Tables[0].Rows[0]["CreatDateTime"].ToString());
				}
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.tab_Orderdetails GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_Orderdetails] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_Orderdetails] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_Orderdetails model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_Orderdetails] set ");
			...
			if (model.Discount != null) strSql.Append("[Discount]=@Discount,");
			if (String.IsNullOrEmpty(model.GoodName) == false) strSql.Append("[GoodName]=@GoodName,");
			if (model.GoodPrice != null) strSql.Append("[GoodPrice]=@GoodPrice,");
			if (model.OrderCount != null) strSql.Append("[OrderCount]=@OrderCount,");
			if (String.IsNullOrEmpty(model.Pinglun) == false) strSql.Append("[Pinglun]=@Pinglun,");
			if (model.ParentID != null) strSql.Append("[ParentID]=@ParentID,");
			if (model.GrandParentID != null) strSql.Append("[GrandParentID]=@GrandParentID,");
			if (model.GreatParentID != null) strSql.Append("[GreatParentID]=@GreatParentID,");
			if (model.TeamID != null) strSql.Append("[TeamID]=@TeamID,");
			if (model.Over7DaysToBeans != null) strSql.Append("[Over7DaysToBeans]=@Over7DaysToBeans,");
			if (String.IsNullOrEmpty(model.VouchersNum_List) == false) strSql.Append("[VouchersNum_List]=@VouchersNum_List,");
			if (model.Beans != null) strSql.Append("[Beans]=@Beans,");
			if (model.MoneyCredits != null) strSql.Append("[MoneyCredits]=@MoneyCredits,");
			if (model.MoneyWeBuy8Credits != null) strSql.Append("[MoneyWeBuy8Credits]=@MoneyWeBuy8Credits,");
			if (model.WealthMoney != null) strSql.Append("[WealthMoney]=@WealthMoney,");
			if (model.Freight != null) strSql.Append("[Freight]=@Freight,");
			...
			if (model.GoodType != null) strSql.Append("[GoodType]=@GoodType,");
			if (model.GoodTypeId != null) strSql.Append("[GoodTypeId]=@GoodTypeId,");
			if (String.IsNullOrEmpty(model.GoodTypeIdBuyInfo) == false) strSql.Append("[GoodTypeIdBuyInfo]=@GoodTypeIdBuyInfo,");
			if ((model.CreatDateTime != null)&&(model.CreatDateTime != DateTime.MinValue)) strSql.Append("[CreatDateTime]=@CreatDateTime,");
			...
			if (model.Discount != null) ParameterToArrayList.Add(new SqlParameter("@Discount",model.Discount));
			if (String.IsNullOrEmpty(model.GoodName) == false) ParameterToArrayList.Add(new SqlParameter("@GoodName",model.GoodName));
			if (model.GoodPrice != null) ParameterToArrayList.Add(new SqlParameter("@GoodPrice",model.GoodPrice));
			if (model.OrderCount != null) ParameterToArrayList.Add(new SqlParameter("@OrderCount",model.OrderCount));
			if (String.IsNullOrEmpty(model.Pinglun) == false) ParameterToArrayList.Add(new SqlParameter("@Pinglun",model.Pinglun));
			if (model.ParentID != null) ParameterToArrayList.Add(new SqlParameter("@ParentID",model.ParentID));
			if (model.GrandParentID != null) ParameterToArrayList.Add(new SqlParameter("@GrandParentID",model.GrandParentID));
			if (model.GreatParentID != null) ParameterToArrayList.Add(new SqlParameter("@GreatParentID",model.GreatParentID));
			if (model.TeamID != null) ParameterToArrayList.Add(new SqlParameter("@TeamID",model.TeamID));
			if (model.Over7DaysToBeans != null) ParameterToArrayList.Add(new SqlParameter("@Over7DaysToBeans",model.Over7DaysToBeans));
			if (String.IsNullOrEmpty(model.VouchersNum_List) == false) ParameterToArrayList.Add(new SqlParameter("@VouchersNum_List",model.VouchersNum_List));
			if (model.Beans != null) ParameterToArrayList.Add(new SqlParameter("@Beans",model.Beans));
			if (model.MoneyCredits != null) ParameterToArrayList.Add(new SqlParameter("@MoneyCredits",model.MoneyCredits));
			if (model.MoneyWeBuy8Credits != null) ParameterToArrayList.Add(new SqlParameter("@MoneyWeBuy8Credits",model.MoneyWeBuy8Credits));
			if (model.WealthMoney != null) ParameterToArrayList.Add(new SqlParameter("@WealthMoney",model.WealthMoney));
			if (model.Freight != null) ParameterToArrayList.Add(new SqlParameter("@Freight",model.Freight));
			...
			if (model.GoodType != null) ParameterToArrayList.Add(new SqlParameter("@GoodType",model.GoodType));
			if (model.GoodTypeId != null) ParameterToArrayList.Add(new SqlParameter("@GoodTypeId",model.GoodTypeId));
			if (String.IsNullOrEmpty(model.GoodTypeIdBuyInfo) == false) ParameterToArrayList.Add(new SqlParameter("@GoodTypeIdBuyInfo",model.GoodTypeIdBuyInfo));
			if ((model.CreatDateTime != null)&&(model.CreatDateTime != DateTime.MinValue)) ParameterToArrayList.Add(new SqlParameter("@CreatDateTime",model.CreatDateTime));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_Orderdetails]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_Orderdetails]", strConditions, orderField, isDesc,ParameterToList);
        }
