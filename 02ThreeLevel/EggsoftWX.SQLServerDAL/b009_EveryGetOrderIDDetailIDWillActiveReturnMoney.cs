...
{
    /// <summary>
    /// 数据访问类b009_EveryGetOrderIDDetailIDWillActiveReturnMoney。
    /// </summary>
    public class b009_EveryGetOrderIDDetailIDWillActiveReturnMoney:Ib009_EveryGetOrderIDDetailIDWillActiveReturnMoney
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney]");
       ...
       /// <summary>
		/// 增加一条数据 model
		/// </summary>
		public Int32 Add(EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney model)
		{
			IDataParameter[] iData = new SqlParameter[2];
			iData[0] = new SqlParameter("@TableName", "b009_EveryGetOrderIDDetailIDWillActiveReturnMoney");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		/// 得到一个对象实体  strWhere
		/// </summary>
		public EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney GetModel(string strWhere, params object[] objs)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney model=new EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["OperationGoodsID"].ToString()!="")
				{
					model.OperationGoodsID=Int32.Parse(ds.Tables[0].Rows[0]["OperationGoodsID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["DecimalReturnMoney"].ToString()!="")
				{
					model.DecimalReturnMoney=decimal.Parse(ds.Tables[0].Rows[0]["DecimalReturnMoney"].ToString());
				}
				if(ds.Tables[0].Rows[0]["OrderID"].ToString()!="")
				{
					model.OrderID=Int32.Parse(ds.Tables[0].Rows[0]["OrderID"].ToString());
				}
				if(ds.Tables[0].Rows[0]["OrderDatailID"].ToString()!="")
				{
					model.OrderDatailID=Int32.Parse(ds.Tables[0].Rows[0]["OrderDatailID"].ToString());
				}
       ...
       #region 得到一个对象实体 ID  memo 0014
		...
		/// 得到一个对象实体
		/// </summary>
		public EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney GetModel(Int32 ID)
		{
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		/// 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney] set ");
			...
			if (model.OperationGoodsID != null) strSql.Append("[OperationGoodsID]=@OperationGoodsID,");
			if (model.DecimalReturnMoney != null) strSql.Append("[DecimalReturnMoney]=@DecimalReturnMoney,");
			if (model.OrderID != null) strSql.Append("[OrderID]=@OrderID,");
			if (model.OrderDatailID != null) strSql.Append("[OrderDatailID]=@OrderDatailID,");
			...
			if (model.OperationGoodsID != null) ParameterToArrayList.Add(new SqlParameter("@OperationGoodsID",model.OperationGoodsID));
			if (model.DecimalReturnMoney != null) ParameterToArrayList.Add(new SqlParameter("@DecimalReturnMoney",model.DecimalReturnMoney));
			if (model.OrderID != null) ParameterToArrayList.Add(new SqlParameter("@OrderID",model.OrderID));
			if (model.OrderDatailID != null) ParameterToArrayList.Add(new SqlParameter("@OrderDatailID",model.OrderDatailID));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [b009_EveryGetOrderIDDetailIDWillActiveReturnMoney]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[b009_EveryGetOrderIDDetailIDWillActiveReturnMoney]", strConditions, orderField, isDesc,ParameterToList);
        }
