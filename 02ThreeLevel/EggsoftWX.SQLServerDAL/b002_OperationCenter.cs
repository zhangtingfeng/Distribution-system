...
{
    /// <summary>
    /// 数据访问类b002_OperationCenter。
    /// </summary>
    public class b002_OperationCenter:Ib002_OperationCenter
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [b002_OperationCenter]");
       ...
       /// <summary>
		...
		public Int32 Add(EggsoftWX.Model.b002_OperationCenter model)
		{
			...
			iData[0] = new SqlParameter("@TableName", "b002_OperationCenter");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [b002_OperationCenter]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [b002_OperationCenter] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [b002_OperationCenter] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       /// <summary>
		...
		public Int32 ExistsCount(string strWhere, params object[] objs)
		{
           strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [b002_OperationCenter] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			object obj=DbHelperSQL.GetSingle(strSql.ToString(),ParameterToList);
			int cmdresult;
			if((Object.Equals(obj,null))||(Object.Equals(obj,System.DBNull.Value)))
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [b002_OperationCenter] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [b002_OperationCenter] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [b002_OperationCenter] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [b002_OperationCenter] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [b002_OperationCenter] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		public EggsoftWX.Model.b002_OperationCenter GetModel(string strWhere, params object[] objs)
		{
			...
			strSql.Append("select * from [b002_OperationCenter] ");
			strSql.Append(" where "+strWhere);
			EggsoftWX.Model.b002_OperationCenter model=new EggsoftWX.Model.b002_OperationCenter();
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["ShopCenterID"].ToString()!="")
				{
					model.ShopCenterID=Int32.Parse(ds.Tables[0].Rows[0]["ShopCenterID"].ToString());
				}
				...
				model.MasterName=ds.Tables[0].Rows[0]["MasterName"].ToString();
				model.MasterPhone=ds.Tables[0].Rows[0]["MasterPhone"].ToString();
				model.MasterAddress=ds.Tables[0].Rows[0]["MasterAddress"].ToString();
				model.BankAccountUserName=ds.Tables[0].Rows[0]["BankAccountUserName"].ToString();
				...
				if(ds.Tables[0].Rows[0]["RunningState"].ToString()!="")
				{
					model.RunningState=Convert.ToBoolean(ds.Tables[0].Rows[0]["RunningState"].ToString());
				}
				if(ds.Tables[0].Rows[0]["AccountState"].ToString()!="")
				{
					model.AccountState=Convert.ToBoolean(ds.Tables[0].Rows[0]["AccountState"].ToString());
				}
				if(ds.Tables[0].Rows[0]["ShareholderState"].ToString()!="")
				{
					model.ShareholderState=Convert.ToBoolean(ds.Tables[0].Rows[0]["ShareholderState"].ToString());
				}
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [b002_OperationCenter] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [b002_OperationCenter] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		public int Update(EggsoftWX.Model.b002_OperationCenter model)
		{
			...
			if (model.ShopCenterID != null) strSql.Append("[ShopCenterID]=@ShopCenterID,");
			...
			if (String.IsNullOrEmpty(model.MasterName) == false) strSql.Append("[MasterName]=@MasterName,");
			if (String.IsNullOrEmpty(model.MasterPhone) == false) strSql.Append("[MasterPhone]=@MasterPhone,");
			if (String.IsNullOrEmpty(model.MasterAddress) == false) strSql.Append("[MasterAddress]=@MasterAddress,");
			if (String.IsNullOrEmpty(model.BankAccountUserName) == false) strSql.Append("[BankAccountUserName]=@BankAccountUserName,");
			if (String.IsNullOrEmpty(model.BankAccountName) == false) strSql.Append("[BankAccountName]=@BankAccountName,");
			if (String.IsNullOrEmpty(model.BankAccountNumber) == false) strSql.Append("[BankAccountNumber]=@BankAccountNumber,");
			if (model.RunningState != null) strSql.Append("[RunningState]=@RunningState,");
			if (model.AccountState != null) strSql.Append("[AccountState]=@AccountState,");
			if (model.ShareholderState != null) strSql.Append("[ShareholderState]=@ShareholderState,");
			...
			if (model.ShopCenterID != null) ParameterToArrayList.Add(new SqlParameter("@ShopCenterID",model.ShopCenterID));
			...
			if (String.IsNullOrEmpty(model.MasterName) == false) ParameterToArrayList.Add(new SqlParameter("@MasterName",model.MasterName));
			if (String.IsNullOrEmpty(model.MasterPhone) == false) ParameterToArrayList.Add(new SqlParameter("@MasterPhone",model.MasterPhone));
			if (String.IsNullOrEmpty(model.MasterAddress) == false) ParameterToArrayList.Add(new SqlParameter("@MasterAddress",model.MasterAddress));
			if (String.IsNullOrEmpty(model.BankAccountUserName) == false) ParameterToArrayList.Add(new SqlParameter("@BankAccountUserName",model.BankAccountUserName));
			if (String.IsNullOrEmpty(model.BankAccountName) == false) ParameterToArrayList.Add(new SqlParameter("@BankAccountName",model.BankAccountName));
			if (String.IsNullOrEmpty(model.BankAccountNumber) == false) ParameterToArrayList.Add(new SqlParameter("@BankAccountNumber",model.BankAccountNumber));
			if (model.RunningState != null) ParameterToArrayList.Add(new SqlParameter("@RunningState",model.RunningState));
			if (model.AccountState != null) ParameterToArrayList.Add(new SqlParameter("@AccountState",model.AccountState));
			if (model.ShareholderState != null) ParameterToArrayList.Add(new SqlParameter("@ShareholderState",model.ShareholderState));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [b002_OperationCenter]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[b002_OperationCenter]", strConditions, orderField, isDesc,ParameterToList);
        }
