...
{
    /// <summary>
    /// 数据访问类tab_User_Address。
    /// </summary>
    public class tab_User_Address:Itab_User_Address
        {
       ...
       /// <summary>
		...
		public Int32 GetMaxId()
		{
			...
			strSql.Append("select max(ID)+1 from [tab_User_Address]");
       ...
       /// <summary>
		...
		public Int32 Add(EggsoftWX.Model.tab_User_Address model)
		{
			...
			iData[0] = new SqlParameter("@TableName", "tab_User_Address");
       ...
       /// <summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tab_User_Address]");
       ...
       /// <summary>
		...
		public bool Exists(string strWhere, params object[] objs)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tab_User_Address] where 1>0 "+strWhere+" ");
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       /// <summary>
		...
		public bool Exists(Int32 ID)
		{
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [tab_User_Address] where ID=" + ID + "");
            object obj = DbHelperSQL.GetSingle(strSql.ToString());
            Int32 cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
       ...
       #region 获得数据列表GetList1 string strWhere memo 0008
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [tab_User_Address] ");
       ...
       #region 获得指定数据列表GetList2 string strItem,string strWhere memo 0009
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select " + strItem + " from [tab_User_Address] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
       ...
       #region IList<string> GetFieldValues  memo 0010
            ...
            public IList<string> GetFieldValues(string fields, string strWhere, params object[] objs)
            {
                StringBuilder strSql = new StringBuilder();
                strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
                strSql.Append("select " + fields + " from [tab_User_Address] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region IList<string> GetFieldValues(string topNum, string fields, string strWhere) memo 0011
        ...
        public IList<string> GetFieldValues(string topNum, string fields, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top " + topNum + " " + fields + " from [tab_User_Address] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
            return DbHelperSQL.GetList(strSql.ToString(),ParameterToList);
        }
       #endregion
       ...
       #region object Scalar(string field, string strWhere) memo 0012
        ...
        public object Scalar(string field, string strWhere, params object[] objs)
        {
            strWhere = strWhere.Trim().ToLower(); if (strWhere != "") if (strWhere.IndexOf("and") != 0) strWhere = "and " + strWhere;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + field + " from [tab_User_Address] where 1>0 " + strWhere);
			SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 得到一个对象实体 strWhere memo 0013
		...
		public EggsoftWX.Model.tab_User_Address GetModel(string strWhere, params object[] objs)
		{
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				model.XiangXiDiZHi=ds.Tables[0].Rows[0]["XiangXiDiZHi"].ToString();
				...
				model.pc_province=ds.Tables[0].Rows[0]["pc_province"].ToString();
				model.pc_city=ds.Tables[0].Rows[0]["pc_city"].ToString();
				model.pc_district=ds.Tables[0].Rows[0]["pc_district"].ToString();
				model.pc_street=ds.Tables[0].Rows[0]["pc_street"].ToString();
				model.pc_state=ds.Tables[0].Rows[0]["pc_state"].ToString();
       ...
       /// <summary>
		...
		{
				StringBuilder strSql=new StringBuilder();
				strSql.Append("delete from [tab_User_Address] ");
				strSql.Append(" where "+strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region update strSet strWhere 更新n条数据 更新n条数据 memo 0017
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tab_User_Address] set ");
			strSql.Append(strSet);
			strSql.Append( " where " );
			strSql.Append(strWhere);
				SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region model update 更新一条数据 memo 0018
		...
		public int Update(EggsoftWX.Model.tab_User_Address model)
		{
			...
			if (String.IsNullOrEmpty(model.XiangXiDiZHi) == false) strSql.Append("[XiangXiDiZHi]=@XiangXiDiZHi,");
			if (String.IsNullOrEmpty(model.PostCode) == false) strSql.Append("[PostCode]=@PostCode,");
			if (String.IsNullOrEmpty(model.RealName) == false) strSql.Append("[RealName]=@RealName,");
			if (String.IsNullOrEmpty(model.MobilePhone) == false) strSql.Append("[MobilePhone]=@MobilePhone,");
			if (String.IsNullOrEmpty(model.TelPhone) == false) strSql.Append("[TelPhone]=@TelPhone,");
			if (String.IsNullOrEmpty(model.BeiZhu) == false) strSql.Append("[BeiZhu]=@BeiZhu,");
			...
			if (String.IsNullOrEmpty(model.pc_province) == false) strSql.Append("[pc_province]=@pc_province,");
			if (String.IsNullOrEmpty(model.pc_city) == false) strSql.Append("[pc_city]=@pc_city,");
			if (String.IsNullOrEmpty(model.pc_district) == false) strSql.Append("[pc_district]=@pc_district,");
			if (String.IsNullOrEmpty(model.pc_street) == false) strSql.Append("[pc_street]=@pc_street,");
			if (String.IsNullOrEmpty(model.pc_state) == false) strSql.Append("[pc_state]=@pc_state,");
			...
			if (String.IsNullOrEmpty(model.XiangXiDiZHi) == false) ParameterToArrayList.Add(new SqlParameter("@XiangXiDiZHi",model.XiangXiDiZHi));
			if (String.IsNullOrEmpty(model.PostCode) == false) ParameterToArrayList.Add(new SqlParameter("@PostCode",model.PostCode));
			if (String.IsNullOrEmpty(model.RealName) == false) ParameterToArrayList.Add(new SqlParameter("@RealName",model.RealName));
			if (String.IsNullOrEmpty(model.MobilePhone) == false) ParameterToArrayList.Add(new SqlParameter("@MobilePhone",model.MobilePhone));
			if (String.IsNullOrEmpty(model.TelPhone) == false) ParameterToArrayList.Add(new SqlParameter("@TelPhone",model.TelPhone));
			if (String.IsNullOrEmpty(model.BeiZhu) == false) ParameterToArrayList.Add(new SqlParameter("@BeiZhu",model.BeiZhu));
			...
			if (String.IsNullOrEmpty(model.pc_province) == false) ParameterToArrayList.Add(new SqlParameter("@pc_province",model.pc_province));
			if (String.IsNullOrEmpty(model.pc_city) == false) ParameterToArrayList.Add(new SqlParameter("@pc_city",model.pc_city));
			if (String.IsNullOrEmpty(model.pc_district) == false) ParameterToArrayList.Add(new SqlParameter("@pc_district",model.pc_district));
			if (String.IsNullOrEmpty(model.pc_street) == false) ParameterToArrayList.Add(new SqlParameter("@pc_street",model.pc_street));
			if (String.IsNullOrEmpty(model.pc_state) == false) ParameterToArrayList.Add(new SqlParameter("@pc_state",model.pc_state));
        ...
        public DataTable GetList(string topNum, string fields, string strWhere, params object[] objs)
       {
           ...
           strSql.Append(" FROM   [tab_User_Address]  where 1 > 0 " + strWhere);
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(strSql.ToString(), objs);
       ...
       #region 大数据量快速分页,50万以上数据分页 memo 0020
        ...
        public DataTable GetPageDataTable(Int32 pageIndex, Int32 pageSize, string fields, string strConditions, string orderField, bool isDesc, params object[] objs)
        {
           ...
           SqlParameter[] ParameterToList = EggsoftWX.SQLServerDAL.Util.ChangeParamsObjectToSqlParameter.ChangeParamsObjectToSqlParameterAction(fields+" "+strConditions+" "+orderField, objs);
            return DbHelperSQL.GetPageDataTable(pageIndex, pageSize, fields, "[tab_User_Address]", strConditions, orderField, isDesc,ParameterToList);
        }
