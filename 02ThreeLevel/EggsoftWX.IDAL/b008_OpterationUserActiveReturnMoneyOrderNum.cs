...
{
	/// <summary>
	/// 接口层Ib008_OpterationUserActiveReturnMoneyOrderNum 的摘要说明。
	/// </summary>
	public interface Ib008_OpterationUserActiveReturnMoneyOrderNum
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b008_OpterationUserActiveReturnMoneyOrderNum model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b008_OpterationUserActiveReturnMoneyOrderNum GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b008_OpterationUserActiveReturnMoneyOrderNum GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.b008_OpterationUserActiveReturnMoneyOrderNum model);//memo 0018
