...
{
	/// <summary>
	/// 接口层Ib019_tab_ShopClient_MultiFenXiaoLevel 的摘要说明。
	/// </summary>
	public interface Ib019_tab_ShopClient_MultiFenXiaoLevel
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b019_tab_ShopClient_MultiFenXiaoLevel model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b019_tab_ShopClient_MultiFenXiaoLevel GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b019_tab_ShopClient_MultiFenXiaoLevel GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.b019_tab_ShopClient_MultiFenXiaoLevel model);//memo 0018
