...
namespace EggsoftWX.IDAL
{
	...
	public interface I_031_ZONE
	{
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model._031_ZONE model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model._031_ZONE GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model._031_ZONE GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model._031_ZONE model);//memo 0018
