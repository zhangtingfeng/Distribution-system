...
{
	/// <summary>
	/// 接口层Itab_TotalCredits_Consume_Or_Recharge 的摘要说明。
	/// </summary>
	public interface Itab_TotalCredits_Consume_Or_Recharge
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.tab_TotalCredits_Consume_Or_Recharge model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.tab_TotalCredits_Consume_Or_Recharge GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.tab_TotalCredits_Consume_Or_Recharge GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.tab_TotalCredits_Consume_Or_Recharge model);//memo 0018
