...
{
	/// <summary>
	/// 接口层Ib007_OperationReturnMoneyEveryDay 的摘要说明。
	/// </summary>
	public interface Ib007_OperationReturnMoneyEveryDay
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b007_OperationReturnMoneyEveryDay model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b007_OperationReturnMoneyEveryDay GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b007_OperationReturnMoneyEveryDay GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.b007_OperationReturnMoneyEveryDay model);//memo 0018
