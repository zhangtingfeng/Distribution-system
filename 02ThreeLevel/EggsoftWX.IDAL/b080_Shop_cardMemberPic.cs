...
{
	/// <summary>
	/// 接口层Ib080_Shop_cardMemberPic 的摘要说明。
	/// </summary>
	public interface Ib080_Shop_cardMemberPic
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b080_Shop_cardMemberPic model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b080_Shop_cardMemberPic GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b080_Shop_cardMemberPic GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.b080_Shop_cardMemberPic model);//memo 0018
