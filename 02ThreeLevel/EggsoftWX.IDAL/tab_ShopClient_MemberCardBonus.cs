...
{
	/// <summary>
	/// 接口层Itab_ShopClient_MemberCardBonus 的摘要说明。
	/// </summary>
	public interface Itab_ShopClient_MemberCardBonus
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.tab_ShopClient_MemberCardBonus model); //memo 0002
		/// <summary>
		/// 增加一条数据 自定义 string strSet,string strValue
		/// </summary>
		int Add(string strSet,string strValue); //memo 0003
		/// <summary>
		/// 是否存在该记录 strWhere
		/// </summary>
		...
		/// 存在该记录条数
		/// </summary>
		int ExistsCount(string strWhere); //memo 0006
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.tab_ShopClient_MemberCardBonus GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.tab_ShopClient_MemberCardBonus GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		void Update(EggsoftWX.Model.tab_ShopClient_MemberCardBonus model);//memo 0018
