...
{
	/// <summary>
	/// 接口层IHelp_Content 的摘要说明。
	/// </summary>
	public interface IHelp_Content
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		Int32 Add(EggsoftWX.Model.Help_Content model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.Help_Content GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.Help_Content GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		void Update(EggsoftWX.Model.Help_Content model);//memo 0018
