...
namespace EggsoftWX.IDAL
{
	...
	public interface Itab_Goods
	{
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.tab_Goods model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.tab_Goods GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.tab_Goods GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.tab_Goods model);//memo 0018
