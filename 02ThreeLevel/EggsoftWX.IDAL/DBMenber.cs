...
namespace EggsoftWX.IDAL
{
	...
	public interface IDBMenber
	{
		...
		/// 增加一条数据 model
		/// </summary>
		Int32 Add(EggsoftWX.Model.DBMenber model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.DBMenber GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.DBMenber GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		void Update(EggsoftWX.Model.DBMenber model);//memo 0018
