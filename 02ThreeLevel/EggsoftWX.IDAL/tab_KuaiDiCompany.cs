...
{
	/// <summary>
	/// 接口层Itab_KuaiDiCompany 的摘要说明。
	/// </summary>
	public interface Itab_KuaiDiCompany
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		Int32 Add(EggsoftWX.Model.tab_KuaiDiCompany model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.tab_KuaiDiCompany GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.tab_KuaiDiCompany GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		void Update(EggsoftWX.Model.tab_KuaiDiCompany model);//memo 0018
