...
{
	/// <summary>
	/// 接口层IView_Amin_ShopClient_Order 的摘要说明。
	/// </summary>
	public interface IView_Amin_ShopClient_Order
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.View_Amin_ShopClient_Order GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.View_Amin_ShopClient_Order GetModel(Int32 ID); //memo 0014
