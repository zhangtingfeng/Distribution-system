...
{
	/// <summary>
	/// 接口层IView_GouWuQuan2XianJInEtc 的摘要说明。
	/// </summary>
	public interface IView_GouWuQuan2XianJInEtc
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.View_GouWuQuan2XianJInEtc GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.View_GouWuQuan2XianJInEtc GetModel(Int32 ID); //memo 0014
