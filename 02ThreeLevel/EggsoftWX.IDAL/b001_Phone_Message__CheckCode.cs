...
{
	/// <summary>
	/// 接口层Ib001_Phone_Message__CheckCode 的摘要说明。
	/// </summary>
	public interface Ib001_Phone_Message__CheckCode
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b001_Phone_Message__CheckCode model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b001_Phone_Message__CheckCode GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b001_Phone_Message__CheckCode GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		void Update(EggsoftWX.Model.b001_Phone_Message__CheckCode model);//memo 0018
