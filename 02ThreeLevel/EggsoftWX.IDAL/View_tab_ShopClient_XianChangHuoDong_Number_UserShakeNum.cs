...
{
	/// <summary>
	/// 接口层IView_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum 的摘要说明。
	/// </summary>
	public interface IView_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.View_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum GetModel(string strWhere);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.View_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum GetModel(Int32 ID); //memo 0014
