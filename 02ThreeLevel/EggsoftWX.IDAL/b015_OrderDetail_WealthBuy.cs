...
{
	/// <summary>
	/// 接口层Ib015_OrderDetail_WealthBuy 的摘要说明。
	/// </summary>
	public interface Ib015_OrderDetail_WealthBuy
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model.b015_OrderDetail_WealthBuy model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model.b015_OrderDetail_WealthBuy GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model.b015_OrderDetail_WealthBuy GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model.b015_OrderDetail_WealthBuy model);//memo 0018
