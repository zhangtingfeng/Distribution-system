...
{
	/// <summary>
	/// 接口层I_031_101FedEx 的摘要说明。
	/// </summary>
	public interface I_031_101FedEx
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 增加一条数据 model
		/// </summary>
		int Add(EggsoftWX.Model._031_101FedEx model); //memo 0002
		/// <summary>
        ...
        /// 得到一个对象实体  GetModel
        /// </summary>
        EggsoftWX.Model._031_101FedEx GetModel(string strWhere, params object[] objs);//memo 0013
		/// <summary>
		/// 得到一个对象实体 strWhere
		/// </summary>
		EggsoftWX.Model._031_101FedEx GetModel(Int32 ID); //memo 0014
		/// <summary>
		...
		///model update 更新一条数据
		/// </summary>
		int Update(EggsoftWX.Model._031_101FedEx model);//memo 0018
