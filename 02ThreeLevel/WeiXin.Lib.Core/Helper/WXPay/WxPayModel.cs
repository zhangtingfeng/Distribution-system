...
namespace WeiXin.Lib.Core.Helper.WXPay
{
    ...
    {
        #region 构造函数、私有变量
        public WxPayModel(int intShopClient,string strAppType="")
        {
            this.parameters = new Dictionary<string, string>();
            WeiXin_ShopClient.getPartnerKey(intShopClient, out AppId, out PartnerKey, out PartnerID, strAppType);
        ...
        /// <returns></returns>
        public static WxPayModel Create(int intShopClientID, string description, string tradeNo, string totalFee, string notifyUrl, string createIp)
        {
            WxPayModel wxPayModel = new WxPayModel(intShopClientID);
            //先设置基本信息
            wxPayModel.SetAppId(wxPayModel.AppId);
            wxPayModel.SetAppKey(WeiXinConst.PaySignKey);
            wxPayModel.SetPartnerKey(wxPayModel.PartnerKey);
            ...
            wxPayModel.SetParameter("partner", wxPayModel.PartnerID);//注册时分配的财付通商户号 partnerId
        ...
        /// <returns></returns>
        public static WxPayModel Create(int intShopClientID, string tradeNo)
        {
            WxPayModel wxPayModel = new WxPayModel(intShopClientID);
            //先设置基本信息
            wxPayModel.SetAppId(wxPayModel.AppId);
        ...
        /// <returns></returns>
        public static WxPayModel Create(int intShopClientID)
        {
            WxPayModel wxPayModel = new WxPayModel(intShopClientID);
            //先设置基本信息
            wxPayModel.SetAppId(wxPayModel.AppId);
        ...
        /// <returns></returns>
        public static WxPayModel Create(int intShopClientID,Dictionary<string, string> dic)
        {
            WxPayModel wxPayModel = new WxPayModel(intShopClientID);
            //先设置基本信息
            wxPayModel.SetAppId(wxPayModel.AppId);
