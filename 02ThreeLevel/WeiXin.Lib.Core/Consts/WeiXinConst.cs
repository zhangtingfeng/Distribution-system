...
namespace WeiXin.Lib.Core.Consts
{
    ...
    public class WeiXin_ShopClient
    {



        public static void getPartnerKey(int intShopClientID, out string strAppId, out string strPartnerKey, out string strPartnerID, string strAppType = "")
        {
            ...
            strAppId = Model_tab_ShopClient_EngineerMode.WeiXinAppId;
            strPartnerKey = Model_tab_ShopClient_EngineerMode.PartnerKey;
            strPartnerID = Model_tab_ShopClient_EngineerMode.WeiXinPayID;
            if (strAppType == "WXSP")
            {
                strAppId = Eggsoft_Public_CL.Pub.stringShowPower(intShopClientID.ToString(), "SmallProgram_APPID");              
            }
    ...
    public class WeiXinConst
    {
        ...
        /// </summary>
        private const string BaiduGeoCoding_ApiUrl = "https://api.map.baidu.com/geocoder/v2/?ak={0}&location={1},{2}&output=json&pois=0";
