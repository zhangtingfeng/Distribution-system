...
{
	/// <summary>
	/// 工厂类b014_OrderDetailEveryReturnWealth 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib014_OrderDetailEveryReturnWealth Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b014_OrderDetailEveryReturnWealth";
			...
			return (Ib014_OrderDetailEveryReturnWealth)objType;
		}
	}
}
