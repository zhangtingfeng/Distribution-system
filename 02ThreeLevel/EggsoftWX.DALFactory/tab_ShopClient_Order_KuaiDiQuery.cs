...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Order_KuaiDiQuery 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Order_KuaiDiQuery Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Order_KuaiDiQuery";
			...
			return (Itab_ShopClient_Order_KuaiDiQuery)objType;
		}
	}
}
