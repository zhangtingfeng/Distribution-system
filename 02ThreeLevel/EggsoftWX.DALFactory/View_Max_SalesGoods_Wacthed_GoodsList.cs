...
{
	/// <summary>
	/// 工厂类View_Max_SalesGoods_Wacthed_GoodsList 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Max_SalesGoods_Wacthed_GoodsList Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Max_SalesGoods_Wacthed_GoodsList";
			...
			return (IView_Max_SalesGoods_Wacthed_GoodsList)objType;
		}
	}
}
