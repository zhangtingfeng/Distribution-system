...
{
	/// <summary>
	/// 工厂类View_ShopClient_Agent_SalesOrderBy 的摘要说明。
	...
	/// </appSettings> 
	/// </summary>
	public class View_ShopClient_Agent_SalesOrderBy
	{
		public static EggsoftWX.IDAL.IView_ShopClient_Agent_SalesOrderBy Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_ShopClient_Agent_SalesOrderBy";
			...
			return (IView_ShopClient_Agent_SalesOrderBy)objType;
		}
	}
}
