...
{
	/// <summary>
	/// 工厂类tab_ShopClient_CustomMultiPhoto 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_CustomMultiPhoto Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_CustomMultiPhoto";
			...
			return (Itab_ShopClient_CustomMultiPhoto)objType;
		}
	}
}
