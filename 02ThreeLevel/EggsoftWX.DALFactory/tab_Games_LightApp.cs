...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_Games_LightApp Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Games_LightApp";
			...
			return (Itab_Games_LightApp)objType;
		}
	}
}
