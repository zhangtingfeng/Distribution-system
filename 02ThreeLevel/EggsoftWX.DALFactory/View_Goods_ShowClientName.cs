...
{
	/// <summary>
	/// 工厂类View_Goods_ShowClientName 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Goods_ShowClientName Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Goods_ShowClientName";
			...
			return (IView_Goods_ShowClientName)objType;
		}
	}
}
