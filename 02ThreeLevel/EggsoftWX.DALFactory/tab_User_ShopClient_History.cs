...
{
	/// <summary>
	/// 工厂类tab_User_ShopClient_History 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_User_ShopClient_History Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_User_ShopClient_History";
			...
			return (Itab_User_ShopClient_History)objType;
		}
	}
}
