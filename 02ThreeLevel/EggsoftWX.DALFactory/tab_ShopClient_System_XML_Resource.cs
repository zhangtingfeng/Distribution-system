...
{
	/// <summary>
	/// 工厂类tab_ShopClient_System_XML_Resource 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_System_XML_Resource Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_System_XML_Resource";
			...
			return (Itab_ShopClient_System_XML_Resource)objType;
		}
	}
}
