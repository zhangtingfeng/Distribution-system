...
{
	/// <summary>
	/// 工厂类View_Goods_Class_Agent 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Goods_Class_Agent Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Goods_Class_Agent";
			...
			return (IView_Goods_Class_Agent)objType;
		}
	}
}
