...
{
	/// <summary>
	/// 工厂类tab_GouWuQuan2XianJInEtc_User 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_GouWuQuan2XianJInEtc_User Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_GouWuQuan2XianJInEtc_User";
			...
			return (Itab_GouWuQuan2XianJInEtc_User)objType;
		}
	}
}
