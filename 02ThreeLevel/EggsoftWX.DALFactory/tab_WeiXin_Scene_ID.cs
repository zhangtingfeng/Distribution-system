...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiXin_Scene_ID Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiXin_Scene_ID";
			...
			return (Itab_WeiXin_Scene_ID)objType;
		}
	}
}
