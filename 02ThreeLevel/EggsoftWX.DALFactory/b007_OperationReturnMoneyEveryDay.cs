...
{
	/// <summary>
	/// 工厂类b007_OperationReturnMoneyEveryDay 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib007_OperationReturnMoneyEveryDay Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b007_OperationReturnMoneyEveryDay";
			...
			return (Ib007_OperationReturnMoneyEveryDay)objType;
		}
	}
}
