...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Net_3D 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Net_3D Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Net_3D";
			...
			return (Itab_ShopClient_Net_3D)objType;
		}
	}
}
