...
{
	/// <summary>
	/// 工厂类tab_ZC_01Product_Support 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ZC_01Product_Support Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ZC_01Product_Support";
			...
			return (Itab_ZC_01Product_Support)objType;
		}
	}
}
