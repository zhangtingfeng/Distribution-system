...
{
	/// <summary>
	/// 工厂类tab_ShopClient_OlineContent 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_OlineContent Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_OlineContent";
			...
			return (Itab_ShopClient_OlineContent)objType;
		}
	}
}
