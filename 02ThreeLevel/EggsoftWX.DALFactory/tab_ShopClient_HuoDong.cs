...
{
	/// <summary>
	/// 工厂类tab_ShopClient_HuoDong 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_HuoDong Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_HuoDong";
			...
			return (Itab_ShopClient_HuoDong)objType;
		}
	}
}
