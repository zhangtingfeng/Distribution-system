...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Agent_Level 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Agent_Level Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Agent_Level";
			...
			return (Itab_ShopClient_Agent_Level)objType;
		}
	}
}
