...
{
	/// <summary>
	/// 工厂类tab_ShopClient_GuidePages 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_GuidePages Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_GuidePages";
			...
			return (Itab_ShopClient_GuidePages)objType;
		}
	}
}
