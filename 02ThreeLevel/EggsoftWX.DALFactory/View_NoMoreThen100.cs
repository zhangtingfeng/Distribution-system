...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.IView_NoMoreThen100 Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_NoMoreThen100";
			...
			return (IView_NoMoreThen100)objType;
		}
	}
}
