...
{
	/// <summary>
	/// 工厂类View_Goods_Sales_Count 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Goods_Sales_Count Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Goods_Sales_Count";
			...
			return (IView_Goods_Sales_Count)objType;
		}
	}
}
