...
{
	/// <summary>
	/// 工厂类tab_Goods_MultiSelectTypePrice 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_Goods_MultiSelectTypePrice Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Goods_MultiSelectTypePrice";
			...
			return (Itab_Goods_MultiSelectTypePrice)objType;
		}
	}
}
