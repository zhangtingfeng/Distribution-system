...
{
	/// <summary>
	/// 工厂类tab_ShopClient_XianChangHuoDong_Number_UserShakeNum 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_XianChangHuoDong_Number_UserShakeNum Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_XianChangHuoDong_Number_UserShakeNum";
			...
			return (Itab_ShopClient_XianChangHuoDong_Number_UserShakeNum)objType;
		}
	}
}
