...
{
	/// <summary>
	/// 工厂类tab_System_AnnouncePic 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_System_AnnouncePic Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_System_AnnouncePic";
			...
			return (Itab_System_AnnouncePic)objType;
		}
	}
}
