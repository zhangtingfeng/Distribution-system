...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.IView_WatchGuidePages Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_WatchGuidePages";
			...
			return (IView_WatchGuidePages)objType;
		}
	}
}
