...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_TuanGou_Partner Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_TuanGou_Partner";
			...
			return (Itab_TuanGou_Partner)objType;
		}
	}
}
