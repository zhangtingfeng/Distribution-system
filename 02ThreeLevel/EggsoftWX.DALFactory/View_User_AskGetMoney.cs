...
{
	/// <summary>
	/// 工厂类View_User_AskGetMoney 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_User_AskGetMoney Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_User_AskGetMoney";
			...
			return (IView_User_AskGetMoney)objType;
		}
	}
}
