...
{
	/// <summary>
	/// 工厂类View_SalesCount03_All_SalesCount_Agent 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_SalesCount03_All_SalesCount_Agent Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_SalesCount03_All_SalesCount_Agent";
			...
			return (IView_SalesCount03_All_SalesCount_Agent)objType;
		}
	}
}
