...
{
	/// <summary>
	/// 工厂类tab_WeiKanJia_Master_Helper 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiKanJia_Master_Helper Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiKanJia_Master_Helper";
			...
			return (Itab_WeiKanJia_Master_Helper)objType;
		}
	}
}
