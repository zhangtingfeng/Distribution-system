...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Ib004_OperationGoods Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b004_OperationGoods";
			...
			return (Ib004_OperationGoods)objType;
		}
	}
}
