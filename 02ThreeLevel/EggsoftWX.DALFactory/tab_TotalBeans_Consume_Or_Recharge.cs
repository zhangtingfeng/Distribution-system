...
{
	/// <summary>
	/// 工厂类tab_TotalBeans_Consume_Or_Recharge 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_TotalBeans_Consume_Or_Recharge Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_TotalBeans_Consume_Or_Recharge";
			...
			return (Itab_TotalBeans_Consume_Or_Recharge)objType;
		}
	}
}
