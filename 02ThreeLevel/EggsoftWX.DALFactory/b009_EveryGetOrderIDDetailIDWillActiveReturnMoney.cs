...
{
	/// <summary>
	/// 工厂类b009_EveryGetOrderIDDetailIDWillActiveReturnMoney 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib009_EveryGetOrderIDDetailIDWillActiveReturnMoney Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b009_EveryGetOrderIDDetailIDWillActiveReturnMoney";
			...
			return (Ib009_EveryGetOrderIDDetailIDWillActiveReturnMoney)objType;
		}
	}
}
