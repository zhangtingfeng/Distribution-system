...
{
	/// <summary>
	/// 工厂类tab_ShopClient_XianChangHuoDong_Bonus 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_XianChangHuoDong_Bonus Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_XianChangHuoDong_Bonus";
			...
			return (Itab_ShopClient_XianChangHuoDong_Bonus)objType;
		}
	}
}
