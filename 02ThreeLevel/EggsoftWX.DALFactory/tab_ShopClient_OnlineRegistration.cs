...
{
	/// <summary>
	/// 工厂类tab_ShopClient_OnlineRegistration 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_OnlineRegistration Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_OnlineRegistration";
			...
			return (Itab_ShopClient_OnlineRegistration)objType;
		}
	}
}
