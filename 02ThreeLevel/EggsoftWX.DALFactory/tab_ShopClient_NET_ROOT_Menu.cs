...
{
	/// <summary>
	/// 工厂类tab_ShopClient_NET_ROOT_Menu 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_NET_ROOT_Menu Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_NET_ROOT_Menu";
			...
			return (Itab_ShopClient_NET_ROOT_Menu)objType;
		}
	}
}
