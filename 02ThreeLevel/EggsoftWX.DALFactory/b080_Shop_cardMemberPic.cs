...
{
	/// <summary>
	/// 工厂类b080_Shop_cardMemberPic 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib080_Shop_cardMemberPic Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b080_Shop_cardMemberPic";
			...
			return (Ib080_Shop_cardMemberPic)objType;
		}
	}
}
