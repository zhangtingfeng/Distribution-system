...
{
	/// <summary>
	/// 工厂类tab_ShopClient_XianChangHuoDong 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_XianChangHuoDong Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_XianChangHuoDong";
			...
			return (Itab_ShopClient_XianChangHuoDong)objType;
		}
	}
}
