...
{
	/// <summary>
	/// 工厂类tab_ShopClient_MemberCard 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_MemberCard Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_MemberCard";
			...
			return (Itab_ShopClient_MemberCard)objType;
		}
	}
}
