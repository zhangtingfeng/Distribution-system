...
{
	/// <summary>
	/// 工厂类tab_ShopClient_WeiXin_Stateurl 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_WeiXin_Stateurl Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_WeiXin_Stateurl";
			...
			return (Itab_ShopClient_WeiXin_Stateurl)objType;
		}
	}
}
