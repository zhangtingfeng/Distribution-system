...
{
	/// <summary>
	/// 工厂类tab_ShopClient_O2O_ShopInfo 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_O2O_ShopInfo Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_O2O_ShopInfo";
			...
			return (Itab_ShopClient_O2O_ShopInfo)objType;
		}
	}
}
