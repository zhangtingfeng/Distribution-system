...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_KuaiDiCompany Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_KuaiDiCompany";
			...
			return (Itab_KuaiDiCompany)objType;
		}
	}
}
