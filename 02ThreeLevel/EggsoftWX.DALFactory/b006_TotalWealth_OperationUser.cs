...
{
	/// <summary>
	/// 工厂类b006_TotalWealth_OperationUser 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib006_TotalWealth_OperationUser Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b006_TotalWealth_OperationUser";
			...
			return (Ib006_TotalWealth_OperationUser)objType;
		}
	}
}
