...
{
	/// <summary>
	/// 工厂类tab_WeiXin_Warning_url 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiXin_Warning_url Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiXin_Warning_url";
			...
			return (Itab_WeiXin_Warning_url)objType;
		}
	}
}
