...
{
	/// <summary>
	/// 工厂类tab_ShopClient_System_Menu_WeiXin 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_System_Menu_WeiXin Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_System_Menu_WeiXin";
			...
			return (Itab_ShopClient_System_Menu_WeiXin)objType;
		}
	}
}
