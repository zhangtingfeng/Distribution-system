...
{
	/// <summary>
	/// 工厂类tab_TransMessage_In_WeinXinPlatform 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_TransMessage_In_WeinXinPlatform Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_TransMessage_In_WeinXinPlatform";
			...
			return (Itab_TransMessage_In_WeinXinPlatform)objType;
		}
	}
}
