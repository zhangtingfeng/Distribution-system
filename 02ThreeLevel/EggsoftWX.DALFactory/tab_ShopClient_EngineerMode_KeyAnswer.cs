...
{
	/// <summary>
	/// 工厂类tab_ShopClient_EngineerMode_KeyAnswer 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_EngineerMode_KeyAnswer Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_EngineerMode_KeyAnswer";
			...
			return (Itab_ShopClient_EngineerMode_KeyAnswer)objType;
		}
	}
}
