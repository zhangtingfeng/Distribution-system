...
{
	/// <summary>
	/// 工厂类tab_ShopClient_XianChangHuoDong_Number 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_XianChangHuoDong_Number Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_XianChangHuoDong_Number";
			...
			return (Itab_ShopClient_XianChangHuoDong_Number)objType;
		}
	}
}
