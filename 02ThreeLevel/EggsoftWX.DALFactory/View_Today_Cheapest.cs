...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.IView_Today_Cheapest Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Today_Cheapest";
			...
			return (IView_Today_Cheapest)objType;
		}
	}
}
