...
{
	/// <summary>
	/// 工厂类tab_Admin_ShopClientPower 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_Admin_ShopClientPower Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Admin_ShopClientPower";
			...
			return (Itab_Admin_ShopClientPower)objType;
		}
	}
}
