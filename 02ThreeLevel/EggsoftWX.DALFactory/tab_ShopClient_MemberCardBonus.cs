...
{
	/// <summary>
	/// 工厂类tab_ShopClient_MemberCardBonus 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_MemberCardBonus Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_MemberCardBonus";
			...
			return (Itab_ShopClient_MemberCardBonus)objType;
		}
	}
}
