...
{
	/// <summary>
	/// 工厂类tab_ShopClient_LightApp_EachPage 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_LightApp_EachPage Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_LightApp_EachPage";
			...
			return (Itab_ShopClient_LightApp_EachPage)objType;
		}
	}
}
