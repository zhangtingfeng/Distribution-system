...
{
	/// <summary>
	/// 工厂类tab_Suggestion_By_Qiu 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_Suggestion_By_Qiu Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Suggestion_By_Qiu";
			...
			return (Itab_Suggestion_By_Qiu)objType;
		}
	}
}
