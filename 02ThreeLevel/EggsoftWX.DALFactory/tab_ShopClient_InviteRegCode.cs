...
{
	/// <summary>
	/// 工厂类tab_ShopClient_InviteRegCode 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_InviteRegCode Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_InviteRegCode";
			...
			return (Itab_ShopClient_InviteRegCode)objType;
		}
	}
}
