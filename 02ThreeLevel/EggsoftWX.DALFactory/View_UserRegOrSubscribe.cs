...
{
	/// <summary>
	/// 工厂类View_UserRegOrSubscribe 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_UserRegOrSubscribe Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_UserRegOrSubscribe";
			...
			return (IView_UserRegOrSubscribe)objType;
		}
	}
}
