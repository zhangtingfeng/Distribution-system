...
{
	/// <summary>
	/// 工厂类tab_ZC_01Product_PartnerList 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ZC_01Product_PartnerList Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ZC_01Product_PartnerList";
			...
			return (Itab_ZC_01Product_PartnerList)objType;
		}
	}
}
