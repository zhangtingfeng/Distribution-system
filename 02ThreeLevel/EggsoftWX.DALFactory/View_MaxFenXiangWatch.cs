...
{
	/// <summary>
	/// 工厂类View_MaxFenXiangWatch 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_MaxFenXiangWatch Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_MaxFenXiangWatch";
			...
			return (IView_MaxFenXiangWatch)objType;
		}
	}
}
