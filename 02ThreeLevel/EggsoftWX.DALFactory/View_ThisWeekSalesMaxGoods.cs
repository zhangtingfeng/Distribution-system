...
{
	/// <summary>
	/// 工厂类View_ThisWeekSalesMaxGoods 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_ThisWeekSalesMaxGoods Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_ThisWeekSalesMaxGoods";
			...
			return (IView_ThisWeekSalesMaxGoods)objType;
		}
	}
}
