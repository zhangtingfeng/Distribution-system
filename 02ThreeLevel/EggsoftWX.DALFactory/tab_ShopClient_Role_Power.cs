...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Role_Power 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Role_Power Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Role_Power";
			...
			return (Itab_ShopClient_Role_Power)objType;
		}
	}
}
