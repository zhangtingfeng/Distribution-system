...
{
	/// <summary>
	/// 工厂类View_GouWuQuan2XianJInEtc 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_GouWuQuan2XianJInEtc Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_GouWuQuan2XianJInEtc";
			...
			return (IView_GouWuQuan2XianJInEtc)objType;
		}
	}
}
