...
{
	/// <summary>
	/// 工厂类b013_WriteOrderByOperation 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib013_WriteOrderByOperation Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b013_WriteOrderByOperation";
			...
			return (Ib013_WriteOrderByOperation)objType;
		}
	}
}
