...
{
	/// <summary>
	/// 工厂类tab_tab_ShopClient_mySonSalesByOrder 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_tab_ShopClient_mySonSalesByOrder Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_tab_ShopClient_mySonSalesByOrder";
			...
			return (Itab_tab_ShopClient_mySonSalesByOrder)objType;
		}
	}
}
