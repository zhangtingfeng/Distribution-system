...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_TuanGou_Number Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_TuanGou_Number";
			...
			return (Itab_TuanGou_Number)objType;
		}
	}
}
