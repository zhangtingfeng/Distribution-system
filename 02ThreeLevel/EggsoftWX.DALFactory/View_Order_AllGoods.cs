...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.IView_Order_AllGoods Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Order_AllGoods";
			...
			return (IView_Order_AllGoods)objType;
		}
	}
}
