...
{
	/// <summary>
	/// 工厂类tab_ShopClient_SearchKeyWordList 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_SearchKeyWordList Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_SearchKeyWordList";
			...
			return (Itab_ShopClient_SearchKeyWordList)objType;
		}
	}
}
