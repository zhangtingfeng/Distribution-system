...
{
	/// <summary>
	/// 工厂类tab_ShopClient_User_Lng_Lat 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_User_Lng_Lat Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_User_Lng_Lat";
			...
			return (Itab_ShopClient_User_Lng_Lat)objType;
		}
	}
}
