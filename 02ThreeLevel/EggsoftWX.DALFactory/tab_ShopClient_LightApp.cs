...
{
	/// <summary>
	/// 工厂类tab_ShopClient_LightApp 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_LightApp Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_LightApp";
			...
			return (Itab_ShopClient_LightApp)objType;
		}
	}
}
