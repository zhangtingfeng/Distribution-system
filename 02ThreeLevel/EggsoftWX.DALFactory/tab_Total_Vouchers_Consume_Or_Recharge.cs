...
{
	/// <summary>
	/// 工厂类tab_Total_Vouchers_Consume_Or_Recharge 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_Total_Vouchers_Consume_Or_Recharge Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Total_Vouchers_Consume_Or_Recharge";
			...
			return (Itab_Total_Vouchers_Consume_Or_Recharge)objType;
		}
	}
}
