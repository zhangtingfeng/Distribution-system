...
{
	/// <summary>
	/// 工厂类tab_AdminFinance_User 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_AdminFinance_User Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_AdminFinance_User";
			...
			return (Itab_AdminFinance_User)objType;
		}
	}
}
