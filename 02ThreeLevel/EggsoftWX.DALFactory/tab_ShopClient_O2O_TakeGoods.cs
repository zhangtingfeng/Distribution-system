...
{
	/// <summary>
	/// 工厂类tab_ShopClient_O2O_TakeGoods 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_O2O_TakeGoods Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_O2O_TakeGoods";
			...
			return (Itab_ShopClient_O2O_TakeGoods)objType;
		}
	}
}
