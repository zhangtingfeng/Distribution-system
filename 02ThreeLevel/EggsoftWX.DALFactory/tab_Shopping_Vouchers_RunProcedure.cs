...
{
	/// <summary>
	/// 工厂类tab_Shopping_Vouchers 的摘要说明。
	...
	{
        public static EggsoftWX.IDAL.Itab_Shopping_Vouchers_RunProcedure Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
            string CacheKey = path + ".tab_Shopping_Vouchers_RunProcedure";
            ...
            return (Itab_Shopping_Vouchers_RunProcedure)objType;
		}
	}
}
