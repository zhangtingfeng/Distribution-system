...
{
	/// <summary>
	/// 工厂类View_ASK_Question_User_And_Shopclient_All_List 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_ASK_Question_User_And_Shopclient_All_List Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_ASK_Question_User_And_Shopclient_All_List";
			...
			return (IView_ASK_Question_User_And_Shopclient_All_List)objType;
		}
	}
}
