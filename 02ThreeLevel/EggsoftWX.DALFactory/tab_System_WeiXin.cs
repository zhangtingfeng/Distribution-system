...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_System_WeiXin Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_System_WeiXin";
			...
			return (Itab_System_WeiXin)objType;
		}
	}
}
