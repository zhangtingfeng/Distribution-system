...
{
	/// <summary>
	/// 工厂类b015_OrderDetail_WealthBuy 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib015_OrderDetail_WealthBuy Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b015_OrderDetail_WealthBuy";
			...
			return (Ib015_OrderDetail_WealthBuy)objType;
		}
	}
}
