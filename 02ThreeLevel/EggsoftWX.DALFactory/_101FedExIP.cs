...
namespace EggsoftWX.DALFactory
{
	...
	/// </appSettings> 
	/// </summary>
	public class _101FedExIP
	{
		public static EggsoftWX.IDAL.I_101FedExIP Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+"._101FedExIP";
