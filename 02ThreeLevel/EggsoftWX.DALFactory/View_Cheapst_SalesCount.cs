...
{
	/// <summary>
	/// 工厂类View_Cheapst_SalesCount 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Cheapst_SalesCount Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Cheapst_SalesCount";
			...
			return (IView_Cheapst_SalesCount)objType;
		}
	}
}
