...
{
	/// <summary>
	/// 工厂类View_GouWuQuan2XianJInEtcUser 的摘要说明。
	...
	/// </appSettings> 
	/// </summary>
	public class View_GouWuQuan2XianJInEtcUser
	{
		public static EggsoftWX.IDAL.IView_GouWuQuan2XianJInEtcUser Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_GouWuQuan2XianJInEtcUser";
			...
			return (IView_GouWuQuan2XianJInEtcUser)objType;
		}
	}
}
