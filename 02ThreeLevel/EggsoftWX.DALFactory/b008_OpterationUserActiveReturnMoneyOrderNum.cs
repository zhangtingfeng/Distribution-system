...
{
	/// <summary>
	/// 工厂类b008_OpterationUserActiveReturnMoneyOrderNum 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib008_OpterationUserActiveReturnMoneyOrderNum Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b008_OpterationUserActiveReturnMoneyOrderNum";
			...
			return (Ib008_OpterationUserActiveReturnMoneyOrderNum)objType;
		}
	}
}
