...
{
	/// <summary>
	/// 工厂类tab_FreightTemplate_Area 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_FreightTemplate_Area Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_FreightTemplate_Area";
			...
			return (Itab_FreightTemplate_Area)objType;
		}
	}
}
