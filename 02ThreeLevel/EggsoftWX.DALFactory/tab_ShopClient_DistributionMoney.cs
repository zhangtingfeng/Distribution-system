...
{
	/// <summary>
	/// 工厂类tab_ShopClient_DistributionMoney 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_DistributionMoney Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_DistributionMoney";
			...
			return (Itab_ShopClient_DistributionMoney)objType;
		}
	}
}
