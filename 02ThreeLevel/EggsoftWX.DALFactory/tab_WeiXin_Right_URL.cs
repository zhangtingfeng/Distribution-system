...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiXin_Right_URL Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiXin_Right_URL";
			...
			return (Itab_WeiXin_Right_URL)objType;
		}
	}
}
