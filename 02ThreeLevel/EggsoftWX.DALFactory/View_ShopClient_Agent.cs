...
{
	/// <summary>
	/// 工厂类View_ShopClient_Agent 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_ShopClient_Agent Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_ShopClient_Agent";
			...
			return (IView_ShopClient_Agent)objType;
		}
	}
}
