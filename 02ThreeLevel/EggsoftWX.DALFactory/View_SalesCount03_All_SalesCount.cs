...
{
	/// <summary>
	/// 工厂类View_SalesCount03_All_SalesCount 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_SalesCount03_All_SalesCount Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_SalesCount03_All_SalesCount";
			...
			return (IView_SalesCount03_All_SalesCount)objType;
		}
	}
}
