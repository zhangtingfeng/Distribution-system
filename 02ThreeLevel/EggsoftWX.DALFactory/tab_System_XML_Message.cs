...
{
	/// <summary>
	/// 工厂类tab_System_XML_Message 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_System_XML_Message Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_System_XML_Message";
			...
			return (Itab_System_XML_Message)objType;
		}
	}
}
