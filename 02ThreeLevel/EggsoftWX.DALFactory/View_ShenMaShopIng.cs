...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.IView_ShenMaShopIng Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_ShenMaShopIng";
			...
			return (IView_ShenMaShopIng)objType;
		}
	}
}
