...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Shopping_VouchersScheme_Detail 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Shopping_VouchersScheme_Detail Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Shopping_VouchersScheme_Detail";
			...
			return (Itab_ShopClient_Shopping_VouchersScheme_Detail)objType;
		}
	}
}
