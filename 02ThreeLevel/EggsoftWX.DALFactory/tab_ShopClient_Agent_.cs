...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Agent_ 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Agent_ Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Agent_";
			...
			return (Itab_ShopClient_Agent_)objType;
		}
	}
}
