...
{
	/// <summary>
	/// 工厂类tab_ShopClient_SignWorkingEveryDay 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_SignWorkingEveryDay Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_SignWorkingEveryDay";
			...
			return (Itab_ShopClient_SignWorkingEveryDay)objType;
		}
	}
}
