...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiKanJia_Master Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiKanJia_Master";
			...
			return (Itab_WeiKanJia_Master)objType;
		}
	}
}
