...
{
	/// <summary>
	/// 工厂类View_Today_Cheapest_Agent 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.IView_Today_Cheapest_Agent Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".View_Today_Cheapest_Agent";
			...
			return (IView_Today_Cheapest_Agent)objType;
		}
	}
}
