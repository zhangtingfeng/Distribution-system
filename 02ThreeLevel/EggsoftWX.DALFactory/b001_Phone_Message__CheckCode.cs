...
{
	/// <summary>
	/// 工厂类b001_Phone_Message__CheckCode 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib001_Phone_Message__CheckCode Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b001_Phone_Message__CheckCode";
			...
			return (Ib001_Phone_Message__CheckCode)objType;
		}
	}
}
