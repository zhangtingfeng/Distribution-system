...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Itab_User_AskGetMoney Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_User_AskGetMoney";
			...
			return (Itab_User_AskGetMoney)objType;
		}
	}
}
