...
{
	/// <summary>
	/// 工厂类tab_System_XML_Resource 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_System_XML_Resource Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_System_XML_Resource";
			...
			return (Itab_System_XML_Resource)objType;
		}
	}
}
