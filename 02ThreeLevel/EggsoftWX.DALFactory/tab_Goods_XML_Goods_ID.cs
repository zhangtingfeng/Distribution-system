...
{
	/// <summary>
	/// 工厂类tab_Goods_XML_Goods_ID 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_Goods_XML_Goods_ID Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_Goods_XML_Goods_ID";
			...
			return (Itab_Goods_XML_Goods_ID)objType;
		}
	}
}
