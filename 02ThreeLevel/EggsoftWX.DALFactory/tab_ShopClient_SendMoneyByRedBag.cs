...
{
	/// <summary>
	/// 工厂类tab_ShopClient_SendMoneyByRedBag 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_SendMoneyByRedBag Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_SendMoneyByRedBag";
			...
			return (Itab_ShopClient_SendMoneyByRedBag)objType;
		}
	}
}
