...
{
	/// <summary>
	/// 工厂类tab_ShopClient_EngineerMode 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_EngineerMode Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_EngineerMode";
			...
			return (Itab_ShopClient_EngineerMode)objType;
		}
	}
}
