...
{
	/// <summary>
	/// 工厂类tab_DistributionMoney 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_DistributionMoney Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_DistributionMoney";
			...
			return (Itab_DistributionMoney)objType;
		}
	}
}
