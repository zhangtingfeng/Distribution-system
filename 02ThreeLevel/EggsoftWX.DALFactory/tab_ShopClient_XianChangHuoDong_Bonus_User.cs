...
{
	/// <summary>
	/// 工厂类tab_ShopClient_XianChangHuoDong_Bonus_User 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_XianChangHuoDong_Bonus_User Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_XianChangHuoDong_Bonus_User";
			...
			return (Itab_ShopClient_XianChangHuoDong_Bonus_User)objType;
		}
	}
}
