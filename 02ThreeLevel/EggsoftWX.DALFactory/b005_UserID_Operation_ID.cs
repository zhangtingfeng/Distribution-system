...
{
	/// <summary>
	/// 工厂类b005_UserID_Operation_ID 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib005_UserID_Operation_ID Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b005_UserID_Operation_ID";
			...
			return (Ib005_UserID_Operation_ID)objType;
		}
	}
}
