...
{
	/// <summary>
	/// 工厂类b017Help_01XianChangHuoDong_Main 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib017Help_01XianChangHuoDong_Main Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b017Help_01XianChangHuoDong_Main";
			...
			return (Ib017Help_01XianChangHuoDong_Main)objType;
		}
	}
}
