...
{
	/// <summary>
	/// 工厂类b016_NoticeGuidePages 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Ib016_NoticeGuidePages Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b016_NoticeGuidePages";
			...
			return (Ib016_NoticeGuidePages)objType;
		}
	}
}
