...
{
	/// <summary>
	/// 工厂类tab_ShopClient_ShopPar 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_ShopPar Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_ShopPar";
			...
			return (Itab_ShopClient_ShopPar)objType;
		}
	}
}
