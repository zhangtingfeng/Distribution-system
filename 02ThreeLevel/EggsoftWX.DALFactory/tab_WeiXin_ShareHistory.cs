...
{
	/// <summary>
	/// 工厂类tab_WeiXin_ShareHistory 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_WeiXin_ShareHistory Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_WeiXin_ShareHistory";
			...
			return (Itab_WeiXin_ShareHistory)objType;
		}
	}
}
