...
{
	/// <summary>
	/// 工厂类tab_ShopClient_Shopping_VouchersScheme 的摘要说明。
	...
	{
		public static EggsoftWX.IDAL.Itab_ShopClient_Shopping_VouchersScheme Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".tab_ShopClient_Shopping_VouchersScheme";
			...
			return (Itab_ShopClient_Shopping_VouchersScheme)objType;
		}
	}
}
