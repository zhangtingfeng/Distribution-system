...
namespace EggsoftWX.DALFactory
{
	...
	{
		public static EggsoftWX.IDAL.Ib002_OperationCenter Create()
		{
			string path = System.Configuration.ConfigurationManager.AppSettings["EggsoftWX.DALFactory"];
			string CacheKey = path+".b002_OperationCenter";
			...
			return (Ib002_OperationCenter)objType;
		}
	}
}
