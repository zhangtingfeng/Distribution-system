...
namespace Com.Alipay
{
    ...
    public class Submit
    {
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            //待请求参数数组
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp)
        {
        ...
        /// <returns>支付宝处理结果</returns>
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string fileName, byte[] data, string contentType, int lengthFile)
        {
