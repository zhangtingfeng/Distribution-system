...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_LightApp 的摘要说明。
	/// </summary>
	public class tab_ShopClient_LightApp
	{
		Itab_ShopClient_LightApp dal=EggsoftWX.DALFactory.tab_ShopClient_LightApp.Create();
