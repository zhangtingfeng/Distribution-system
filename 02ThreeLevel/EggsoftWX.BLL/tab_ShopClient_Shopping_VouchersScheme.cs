...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_Shopping_VouchersScheme 的摘要说明。
	/// </summary>
	public class tab_ShopClient_Shopping_VouchersScheme
	{
		Itab_ShopClient_Shopping_VouchersScheme dal=EggsoftWX.DALFactory.tab_ShopClient_Shopping_VouchersScheme.Create();
