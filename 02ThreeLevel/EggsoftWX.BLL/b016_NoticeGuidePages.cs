...
{
	/// <summary>
	/// 业务逻辑类b016_NoticeGuidePages 的摘要说明。
	/// </summary>
	public class b016_NoticeGuidePages
	{
		Ib016_NoticeGuidePages dal=EggsoftWX.DALFactory.b016_NoticeGuidePages.Create();
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.b016_NoticeGuidePages model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.b016_NoticeGuidePages GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.b016_NoticeGuidePages GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.b016_NoticeGuidePages model)
		{
