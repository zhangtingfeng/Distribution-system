...
{
	/// <summary>
	/// 业务逻辑类b008_OpterationUserActiveReturnMoneyOrderNum 的摘要说明。
	/// </summary>
	public class b008_OpterationUserActiveReturnMoneyOrderNum
	{
		Ib008_OpterationUserActiveReturnMoneyOrderNum dal=EggsoftWX.DALFactory.b008_OpterationUserActiveReturnMoneyOrderNum.Create();
