...
{
	/// <summary>
	/// 业务逻辑类tab_TotalCredits_Consume_Or_Recharge 的摘要说明。
	/// </summary>
	public class tab_TotalCredits_Consume_Or_Recharge
	{
		Itab_TotalCredits_Consume_Or_Recharge dal=EggsoftWX.DALFactory.tab_TotalCredits_Consume_Or_Recharge.Create();
