...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_Agent_Level_ProductInfo 的摘要说明。
	/// </summary>
	public class tab_ShopClient_Agent_Level_ProductInfo
	{
		Itab_ShopClient_Agent_Level_ProductInfo dal=EggsoftWX.DALFactory.tab_ShopClient_Agent_Level_ProductInfo.Create();
