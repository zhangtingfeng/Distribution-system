...
{
	/// <summary>
	/// 业务逻辑类tab_GouWuQuan2XianJInEtc_User 的摘要说明。
	/// </summary>
	public class tab_GouWuQuan2XianJInEtc_User
	{
		Itab_GouWuQuan2XianJInEtc_User dal=EggsoftWX.DALFactory.tab_GouWuQuan2XianJInEtc_User.Create();
