...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_EngineerMode 的摘要说明。
	/// </summary>
	public class tab_ShopClient_EngineerMode
	{
		Itab_ShopClient_EngineerMode dal=EggsoftWX.DALFactory.tab_ShopClient_EngineerMode.Create();
