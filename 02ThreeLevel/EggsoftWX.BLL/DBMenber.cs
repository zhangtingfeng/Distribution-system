...
namespace EggsoftWX.BLL
{
	...
	{
		IDBMenber dal=EggsoftWX.DALFactory.DBMenber.Create();
		public DBMenber()
		{}
		#region  成员方法
		...
		/// 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.DBMenber model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.DBMenber GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.DBMenber GetModel(string strWhere)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public void Update(EggsoftWX.Model.DBMenber model)
		{
			dal.Update(model);
		}
