...
{
	/// <summary>
	/// 业务逻辑类tab_User_Address 的摘要说明。
	/// </summary>
	public class tab_User_Address
	{
		Itab_User_Address dal=EggsoftWX.DALFactory.tab_User_Address.Create();
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_User_Address model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.tab_User_Address GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.tab_User_Address GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_User_Address model)
		{
