...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_XianChangHuoDong_Number 的摘要说明。
	/// </summary>
	public class tab_ShopClient_XianChangHuoDong_Number
	{
		Itab_ShopClient_XianChangHuoDong_Number dal=EggsoftWX.DALFactory.tab_ShopClient_XianChangHuoDong_Number.Create();
