...
{
	/// <summary>
	/// 业务逻辑类b018Help_01XianChangHuoDong_UserShake 的摘要说明。
	/// </summary>
	public class b018Help_01XianChangHuoDong_UserShake
	{
		Ib018Help_01XianChangHuoDong_UserShake dal=EggsoftWX.DALFactory.b018Help_01XianChangHuoDong_UserShake.Create();
