...
{
	/// <summary>
	/// 业务逻辑类tab_TransMessage_In_WeinXinPlatform 的摘要说明。
	/// </summary>
	public class tab_TransMessage_In_WeinXinPlatform
	{
		Itab_TransMessage_In_WeinXinPlatform dal=EggsoftWX.DALFactory.tab_TransMessage_In_WeinXinPlatform.Create();
