...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_Shopping_VouchersScheme_Detail 的摘要说明。
	/// </summary>
	public class tab_ShopClient_Shopping_VouchersScheme_Detail
	{
		Itab_ShopClient_Shopping_VouchersScheme_Detail dal=EggsoftWX.DALFactory.tab_ShopClient_Shopping_VouchersScheme_Detail.Create();
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public void Update(EggsoftWX.Model.tab_ShopClient_Shopping_VouchersScheme_Detail model)
		{
			dal.Update(model);
		}
