...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_System_XML_Resource 的摘要说明。
	/// </summary>
	public class tab_ShopClient_System_XML_Resource
	{
		Itab_ShopClient_System_XML_Resource dal=EggsoftWX.DALFactory.tab_ShopClient_System_XML_Resource.Create();
