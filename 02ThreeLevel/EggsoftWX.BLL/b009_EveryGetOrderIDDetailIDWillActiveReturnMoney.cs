...
{
	/// <summary>
	/// 业务逻辑类b009_EveryGetOrderIDDetailIDWillActiveReturnMoney 的摘要说明。
	/// </summary>
	public class b009_EveryGetOrderIDDetailIDWillActiveReturnMoney
	{
		Ib009_EveryGetOrderIDDetailIDWillActiveReturnMoney dal=EggsoftWX.DALFactory.b009_EveryGetOrderIDDetailIDWillActiveReturnMoney.Create();
