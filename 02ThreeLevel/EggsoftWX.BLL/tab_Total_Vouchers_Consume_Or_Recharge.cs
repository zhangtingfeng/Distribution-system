...
{
	/// <summary>
	/// 业务逻辑类tab_Total_Vouchers_Consume_Or_Recharge 的摘要说明。
	/// </summary>
	public class tab_Total_Vouchers_Consume_Or_Recharge
	{
		Itab_Total_Vouchers_Consume_Or_Recharge dal=EggsoftWX.DALFactory.tab_Total_Vouchers_Consume_Or_Recharge.Create();
