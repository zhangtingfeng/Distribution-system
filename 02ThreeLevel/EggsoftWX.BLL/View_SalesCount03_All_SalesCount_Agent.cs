...
{
	/// <summary>
	/// 业务逻辑类View_SalesCount03_All_SalesCount_Agent 的摘要说明。
	/// </summary>
	public class View_SalesCount03_All_SalesCount_Agent
	{
		IView_SalesCount03_All_SalesCount_Agent dal=EggsoftWX.DALFactory.View_SalesCount03_All_SalesCount_Agent.Create();
