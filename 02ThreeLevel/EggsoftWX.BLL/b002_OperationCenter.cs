...
{
	/// <summary>
	/// 业务逻辑类b002_OperationCenter 的摘要说明。
	/// </summary>
	public class b002_OperationCenter
	{
		Ib002_OperationCenter dal=EggsoftWX.DALFactory.b002_OperationCenter.Create();
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.b002_OperationCenter model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.b002_OperationCenter GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.b002_OperationCenter GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.b002_OperationCenter model)
		{
