...
{
	/// <summary>
	/// 业务逻辑类tab_tab_ShopClient_mySonSalesByOrder 的摘要说明。
	/// </summary>
	public class tab_tab_ShopClient_mySonSalesByOrder
	{
		Itab_tab_ShopClient_mySonSalesByOrder dal=EggsoftWX.DALFactory.tab_tab_ShopClient_mySonSalesByOrder.Create();
