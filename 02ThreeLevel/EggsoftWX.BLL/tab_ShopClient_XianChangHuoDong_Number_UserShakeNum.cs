...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_XianChangHuoDong_Number_UserShakeNum 的摘要说明。
	/// </summary>
	public class tab_ShopClient_XianChangHuoDong_Number_UserShakeNum
	{
		Itab_ShopClient_XianChangHuoDong_Number_UserShakeNum dal=EggsoftWX.DALFactory.tab_ShopClient_XianChangHuoDong_Number_UserShakeNum.Create();
