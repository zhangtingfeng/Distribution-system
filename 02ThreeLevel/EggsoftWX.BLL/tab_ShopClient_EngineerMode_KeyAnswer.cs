...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_EngineerMode_KeyAnswer 的摘要说明。
	/// </summary>
	public class tab_ShopClient_EngineerMode_KeyAnswer
	{
		Itab_ShopClient_EngineerMode_KeyAnswer dal=EggsoftWX.DALFactory.tab_ShopClient_EngineerMode_KeyAnswer.Create();
