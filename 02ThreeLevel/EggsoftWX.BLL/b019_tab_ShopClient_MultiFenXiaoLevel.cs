...
{
	/// <summary>
	/// 业务逻辑类b019_tab_ShopClient_MultiFenXiaoLevel 的摘要说明。
	/// </summary>
	public class b019_tab_ShopClient_MultiFenXiaoLevel
	{
		Ib019_tab_ShopClient_MultiFenXiaoLevel dal=EggsoftWX.DALFactory.b019_tab_ShopClient_MultiFenXiaoLevel.Create();
