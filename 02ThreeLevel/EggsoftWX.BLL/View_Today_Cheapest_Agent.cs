...
{
	/// <summary>
	/// 业务逻辑类View_Today_Cheapest_Agent 的摘要说明。
	/// </summary>
	public class View_Today_Cheapest_Agent
	{
		IView_Today_Cheapest_Agent dal=EggsoftWX.DALFactory.View_Today_Cheapest_Agent.Create();
