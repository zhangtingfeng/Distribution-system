...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_LightApp_EachPage 的摘要说明。
	/// </summary>
	public class tab_ShopClient_LightApp_EachPage
	{
		Itab_ShopClient_LightApp_EachPage dal=EggsoftWX.DALFactory.tab_ShopClient_LightApp_EachPage.Create();
