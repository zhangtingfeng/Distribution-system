...
{
	/// <summary>
	/// 业务逻辑类tab_tab_ShopClient_myGetFenXiaoMoneyHistory 的摘要说明。
	/// </summary>
	public class tab_tab_ShopClient_myGetFenXiaoMoneyHistory
	{
		Itab_tab_ShopClient_myGetFenXiaoMoneyHistory dal=EggsoftWX.DALFactory.tab_tab_ShopClient_myGetFenXiaoMoneyHistory.Create();
