...
{
	/// <summary>
	/// 业务逻辑类View_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum 的摘要说明。
	/// </summary>
	public class View_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum
	{
		IView_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum dal=EggsoftWX.DALFactory.View_tab_ShopClient_XianChangHuoDong_Number_UserShakeNum.Create();
