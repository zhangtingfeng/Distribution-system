...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_XianChangHuoDong_Bonus_User 的摘要说明。
	/// </summary>
	public class tab_ShopClient_XianChangHuoDong_Bonus_User
	{
		Itab_ShopClient_XianChangHuoDong_Bonus_User dal=EggsoftWX.DALFactory.tab_ShopClient_XianChangHuoDong_Bonus_User.Create();
