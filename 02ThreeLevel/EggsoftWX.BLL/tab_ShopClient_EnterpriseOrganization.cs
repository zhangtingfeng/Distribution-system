...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_EnterpriseOrganization 的摘要说明。
	/// </summary>
	public class tab_ShopClient_EnterpriseOrganization
	{
		Itab_ShopClient_EnterpriseOrganization dal=EggsoftWX.DALFactory.tab_ShopClient_EnterpriseOrganization.Create();
