...
{
	/// <summary>
	/// 业务逻辑类View_tab_ShopClient_XianChangHuoDong_Bonus_User 的摘要说明。
	/// </summary>
	public class View_tab_ShopClient_XianChangHuoDong_Bonus_User
	{
		IView_tab_ShopClient_XianChangHuoDong_Bonus_User dal=EggsoftWX.DALFactory.View_tab_ShopClient_XianChangHuoDong_Bonus_User.Create();
