...
{
	/// <summary>
	/// 业务逻辑类tab_User_Good_History 的摘要说明。
	/// </summary>
	public class tab_User_Good_History
	{
		Itab_User_Good_History dal=EggsoftWX.DALFactory.tab_User_Good_History.Create();
		public tab_User_Good_History()
		{}
		#region  成员方法
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_User_Good_History model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.tab_User_Good_History GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.tab_User_Good_History GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public void Update(EggsoftWX.Model.tab_User_Good_History model)
		{
			dal.Update(model);
		}
