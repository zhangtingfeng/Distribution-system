...
{
	/// <summary>
	/// 业务逻辑类View_Max_SalesGoods_Wacthed_GoodsList 的摘要说明。
	/// </summary>
	public class View_Max_SalesGoods_Wacthed_GoodsList
	{
		IView_Max_SalesGoods_Wacthed_GoodsList dal=EggsoftWX.DALFactory.View_Max_SalesGoods_Wacthed_GoodsList.Create();
