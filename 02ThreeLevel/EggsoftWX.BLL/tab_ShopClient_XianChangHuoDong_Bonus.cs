...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_XianChangHuoDong_Bonus 的摘要说明。
	/// </summary>
	public class tab_ShopClient_XianChangHuoDong_Bonus
	{
		Itab_ShopClient_XianChangHuoDong_Bonus dal=EggsoftWX.DALFactory.tab_ShopClient_XianChangHuoDong_Bonus.Create();
