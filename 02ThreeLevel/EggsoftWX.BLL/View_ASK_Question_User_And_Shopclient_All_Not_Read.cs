...
{
	/// <summary>
	/// 业务逻辑类View_ASK_Question_User_And_Shopclient_All_Not_Read 的摘要说明。
	/// </summary>
	public class View_ASK_Question_User_And_Shopclient_All_Not_Read
	{
		IView_ASK_Question_User_And_Shopclient_All_Not_Read dal=EggsoftWX.DALFactory.View_ASK_Question_User_And_Shopclient_All_Not_Read.Create();
