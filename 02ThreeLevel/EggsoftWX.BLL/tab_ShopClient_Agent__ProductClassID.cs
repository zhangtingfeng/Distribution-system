...
{
	/// <summary>
	/// 业务逻辑类tab_ShopClient_Agent__ProductClassID 的摘要说明。
	/// </summary>
	public class tab_ShopClient_Agent__ProductClassID
	{
		Itab_ShopClient_Agent__ProductClassID dal=EggsoftWX.DALFactory.tab_ShopClient_Agent__ProductClassID.Create();
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_ShopClient_Agent__ProductClassID model)
		{
