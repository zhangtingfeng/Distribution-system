...
{
	/// <summary>
	/// 业务逻辑类View_GouWuQuan2XianJInEtc 的摘要说明。
	/// </summary>
	public class View_GouWuQuan2XianJInEtc
	{
		IView_GouWuQuan2XianJInEtc dal=EggsoftWX.DALFactory.View_GouWuQuan2XianJInEtc.Create();
