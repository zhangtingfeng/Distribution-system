...
{
	/// <summary>
	/// 业务逻辑类tab_Class3 的摘要说明。
	/// </summary>
	public class tab_Class3
	{
		Itab_Class3 dal=EggsoftWX.DALFactory.tab_Class3.Create();
		public tab_Class3()
		{}
		#region  成员方法
		...
		/// 2 增加一条数据
		/// </summary>
		public Int32 Add(EggsoftWX.Model.tab_Class3 model)
		{
		...
		/// 得到一个对象实体 strWhere
		/// </summary>
		public EggsoftWX.Model.tab_Class3 GetModel(Int32 ID)
		{
        ...
        /// 得到一个对象实体 strWhere
        /// </summary>
        public EggsoftWX.Model.tab_Class3 GetModel(string strWhere, params object[] objs)
        {
		...
		///model update 更新一条数据
		/// </summary>
		public int Update(EggsoftWX.Model.tab_Class3 model)
		{
