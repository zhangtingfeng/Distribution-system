<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="_12upload.eggsoft.cn.UpLoadFile.ClientAdmin.ContactUs" %>
                    ...
                    <table class="border" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0" align="center" border="0">
                        ...
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            ...
                            <td bgcolor="#ecf5ff" height="35">
                                ...
                                <asp:TextBox ID="TextBox_LINK" runat="server" Width="678px" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            <td align="right" height="35" class="style1">
