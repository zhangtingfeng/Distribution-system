...
{
    public partial class ConsumerWealthAgreement : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        private void setConsumerWealthAgreement(string strWay)
        {
            ...
            if (strWay == "Show")
            {
                if (Model != null)
                {
                    string Server_Str = Model.ConsumerWealthAgreement;
            ...
            else if (strWay == "Save")
            {
                ...
                Model.ConsumerWealthAgreement = strHtmlSave;
                ...
                if (String.IsNullOrEmpty(Model.ConsumerWealthAgreement))
                {
                    EggsoftWX.SQLServerDAL.DbHelperSQL.ExecuteSql("update b004_OperationGoods set ConsumerWealthAgreement=null where id=" + Model.ID);
                }
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            JsUtil.ShowMsg("保存成功!", "ConsumerWealthAgreement.aspx?Usersb004_OperationGoodsID="+ pSTR_webuy8_ClientAdmin_Usersb004_OperationGoodsID);
