<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StyleModeDoSelf.aspx.cs" Inherits="_12upload.eggsoft.cn.UpLoadFile.ClientAdmin.StyleModeDoSelf" %>
            ...
            <tr>
                <td valign="top" align="center" style="width: 100%">
                    <table class="border" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0" align="center" border="0">
                        <tr class="title">
                            <th bgcolor="#ecf5ff" class="centerAuto" colspan="2" height="25">分销商城首页自定义</th>
                        </tr>
                        ...
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            ...
                            <td bgcolor="#ecf5ff" height="35">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="Text_setContactUs" runat="server" TextMode="MultiLine" Height="347px"
