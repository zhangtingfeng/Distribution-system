...
{
    public partial class writeHtml_StyleModel2 : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void makeIndex(int intShopClient)
        {
            ...
            strHTML += "    <meta content=\"width=device-width, initial-scale=1.0\" name=\"viewport\" />\n";
            ...
            strHTML += "    <link href=\"/Templet/01WYJS/Css/mall.css?version=css201709121928\" type=\"text/css\" rel=\"stylesheet\">\n";
            ...
            strHTML += "    <link href=\"/Templet/03LiuShenMa/Css/03LiuShenMa.css?version=css201709121928\" type=\"text/css\" rel=\"stylesheet\">\n";
            ...
            strHTML += "     doInfoAlert_Msg(###UserID###);}///对于未关注用户 这是唯一的提示渠道 发信息渠道";
            strHTML += "  \n";
            ...
            strHTML += "         dataType: 'text',\n";
            strHTML += "        data:'strpub_Int_ShopClientID=###ToShopCilentID###&strpub_Int_Session_CurUserID=###UserID###',\n";
            strHTML += "        beforeSend:function(){\n";
            strHTML += "            $(\"#GoodAgentClass\").append('<img style=\"margin: 0px auto;display:block;\" src=\"/images/loading.gif\"/>');\n";
            strHTML += "        },\n";
            strHTML += "         success:function(msg)\n";
            strHTML += "        {\n";
            strHTML += "            //alert(msg);\n";
            strHTML += "             $(\"#GoodAgentClass\").html(msg);\n";
            strHTML += "         },\n";
            strHTML += "        error: function(data){\n";
            strHTML += "          }\n";
            strHTML += "     })\n";
            ...
            strHTML += "         dataType: 'text',\n";
            strHTML += "        data:'pClassGoodType=0&strpub_Int_ShopClientID='+'###ToShopCilentID###'+'&strpub_Int_Session_CurUserID=###UserID###'+'&strpInt_QueryString_ParentID=###ParentID###',\n";
            strHTML += "        beforeSend:function(){\n";
            ...
            if (boolExsit_O2O_ShopInfo)
            {
                ...
                //strHTML += "          <span><a href=\"/sagent-5/guidepage-1.aspx\">品牌介绍</a></span>\n";
                //strHTML += "           <span><a href=\"/sagent-5/guidepage-2.aspx\">产品功能</a></span>\n";
            ...
            strHTML += "  <div id=\"Redline\"></div>\n";
            strHTML += "<div id=\"GoodAgentClass\" class=\"jx_map\"></div>\n";

            strHTML += "<div class=\"SAgent_ChoiceGood\"></div>\n";

            strHTML += "<div id=\"SAgent_ProductNewGoodClass\"></div>\n";
