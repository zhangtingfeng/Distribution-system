...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        if (String.IsNullOrEmpty(strwebuy8_ClientAdmin_Users) == true)
        {
            strwebuy8_ClientAdmin_Users = "upload";
            BaseUrl = "/upload/";
        }
        else
        {
            BaseUrl = Eggsoft_Public_CL.Upload.getUploadPathFromShopClientID(Int32.Parse(strwebuy8_ClientAdmin_Users)) + "/";
        }
