<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUC_DateTime.ascx.cs" Inherits="_05Client.eggsoft.cn.Control.WebUC_DateTime1" %>
...
<asp:Table ID="Table_Show" runat="server" Width="816px" Visible="False" 
    ...
    <asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Center">
        <asp:TableCell ID="TableCell1" runat="server" VerticalAlign="Top">选择日期：<br /><asp:Calendar ID="Calendar1" runat="server"></asp:Calendar>
</asp:TableCell>
