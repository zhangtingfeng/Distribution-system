<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiFenXiaoLevel_Board.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._15Advance.MultiFenXiaoLevel_Board" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <div class="mhead">
            <h1>团 队 奖 励 方 案 管 理 </h1>
            <span style="color: #3333FF; display: none;">替换标识符：###productlist###</span>
            <div class="mselct">
                管理选项：<asp:Button ID="btnAdd" runat="server" Text="添加分销代理方案" OnClick="btnAdd_Click" Style="text-align: center" />
            &nbsp;
                <asp:Label ID="Label_Show" runat="server" Text=""></asp:Label>
                <asp:Button ID="btnResetAllGood" runat="server" Text="自动更新所有代理商的商品" Visible="false" OnClick="btnResetAllGood_Click" Style="text-align: center" />
            </div>
        </div>
