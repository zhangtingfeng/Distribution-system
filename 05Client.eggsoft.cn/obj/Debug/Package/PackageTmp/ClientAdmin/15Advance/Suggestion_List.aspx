<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Suggestion_List.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._15Advance.Suggestion_List" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <div class="mhead">
            <h1>意 见 反 馈 管 理 </h1>
            <div class="mselct">
                管理选项：<asp:Button ID="btnAdd" runat="server" Text="添加意见反馈" OnClick="btnAdd_Click" Style="text-align: center" />
            </div>
        </div>
