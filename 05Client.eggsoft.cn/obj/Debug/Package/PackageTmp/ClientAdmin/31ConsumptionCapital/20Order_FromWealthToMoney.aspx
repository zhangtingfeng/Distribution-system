<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="20Order_FromWealthToMoney.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._31ConsumptionCapital._20Order_FromWealthToMoney" %>
                ...
                <td width="100%" valign="top" align="center" style="text-align: center;">
                    <asp:GridView ID="gvAnnounce" runat="server" AllowSorting="True" AutoGenerateColumns="False" GridLines="Horizontal" BorderWidth="0px" BorderColor="#EFEFEF" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="RemainingSum" HeaderText="用户账户扣除后的余额(用户对账可参考)" DataFormatString="{0:C}">
                                <HeaderStyle Width="8%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
