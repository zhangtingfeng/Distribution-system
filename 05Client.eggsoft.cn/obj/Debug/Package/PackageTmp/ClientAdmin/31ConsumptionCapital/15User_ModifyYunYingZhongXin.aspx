<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="15User_ModifyYunYingZhongXin.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._09System_Status._15User_ModifyYunYingZhongXin" %>
                ...
                <tr>
                    <td valign="top" align="center" style="width: 100%">
                        ...
                        <table class="borderClass" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0" align="center" border="0">
                            ...
                            <tr class="tdbg" bgcolor="#c0c0c0">
                                <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                    <div align="right"><strong>运营中心号：</strong></div>
                                </td>
                                <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                    <div align="left" style="margin-right: 100px;">
                                        <asp:TextBox ID="TextBox_YunYingZhongXinID" runat="server" AutoPostBack="True" OnTextChanged="TextBox_YunYingZhongXinID_TextChanged"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <tr class="tdbg" bgcolor="#c0c0c0">
                                        <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                            <div align="right"><strong>运营中心昵称：</strong></div>
                                        </td>
                                        <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                            <div align="left" style="margin-right: 100px;">
                                                 <asp:Label ID="Label1YunYinZhongXinParentNickName" runat="server" Text="Label"></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="tdbg" bgcolor="#c0c0c0">
                                        <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                            <div align="right"><strong>运营中心头像头像：</strong></div>
                                        </td>
                                        <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                            <div align="left" style="margin-right: 100px;">
                                                <asp:Image ID="Image1YunYinZhongXin" Width="40px" runat="server" />
                                            </div>
                                        </td>
                                    </tr>
