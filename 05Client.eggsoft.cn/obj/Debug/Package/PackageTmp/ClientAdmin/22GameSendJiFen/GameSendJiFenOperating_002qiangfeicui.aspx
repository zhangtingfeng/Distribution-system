<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameSendJiFenOperating_002qiangfeicui.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._22GameSendJiFen.GameSendJiFenOperating_002qiangfeicui" %>
    ...
    <form id="form1" runat="server">
        <table class="border" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0"
            ...
            <tr class="tdbg" bgcolor="#e3e3e3">
                ...
                <td bgcolor="#ecf5ff">
                    <asp:TextBox ID="TextBox_Name" runat="server" Width="137px" CssClass="l_input" MaxLength="20">土豪抢翡翠</asp:TextBox>
