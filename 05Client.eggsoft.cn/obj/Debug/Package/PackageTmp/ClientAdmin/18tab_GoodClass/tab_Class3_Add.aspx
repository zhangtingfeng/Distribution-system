<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab_Class3_Add.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._18tab_GoodClass.tab_Class3_Add" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <table class="border" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0"
            ...
            <tr class="title">
                <th align="center" colspan="2" height="25"><strong>添加三级分类</strong></th>
            </tr>
            <tr class="tdbg" bgcolor="#e3e3e3">
                <td height="36" align="right">
                    <strong>一级分类、二级分类：</strong>
                </td>
                <td style="height: 36px" bgcolor="#ecf5ff">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                        ErrorMessage="二类分类名称不能为空!" ControlToValidate="ddlBigClass2" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="tdbg" bgcolor="#e3e3e3">
                ...
                <td align="center" bgcolor="#ecf5ff" height="35">
                    <div align="left">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtSmallClassPos"
                            ErrorMessage="排列位置必须是数字类型!" ValidationExpression="^\d{1,}$" Display="Dynamic"></asp:RegularExpressionValidator>
                    </div>
                </td>
            </tr>
            ...
            <tr class="tdbg" bgcolor="#ecf5ff">
                ...
                <td align="left" bgcolor="#ecf5ff" height="45">
                    <asp:Button ID="btnAdd" runat="server" Width="72px" Text=" 添  加 " OnClick="btnAdd_Click" CssClass="b_input"></asp:Button>
                </td>
            </tr>
