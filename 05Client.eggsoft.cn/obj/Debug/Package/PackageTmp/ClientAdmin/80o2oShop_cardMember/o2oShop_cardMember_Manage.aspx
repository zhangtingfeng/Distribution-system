<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="o2oShop_cardMember_Manage.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._80o2oShop_cardMember.o2oShop_cardMember_Manage" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <table class="border" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0" align="center" border="0">
            ...
            <tr class="tdbg" bgcolor="#e3e3e3">
                <td align="right" height="35" class="style3">
                    <strong>中文积分规则描述：</strong>
                </td>
                <td align="left" bgcolor="#ecf5ff" height="35">
                    <asp:TextBox ID="CDescriptionTextBox1" runat="server" Width="376px" CssClass="l_input" Height="65px" Rows="5" TextMode="MultiLine">#</asp:TextBox>
                    <span class="style1"><strong>*</strong></span></td>
            </tr>
            <tr class="tdbg" bgcolor="#e3e3e3">
                <td align="right" height="35" class="style3">
                    <strong>英文积分规则描述：</strong>
                </td>
                <td align="left" bgcolor="#ecf5ff" height="35">
                    <asp:TextBox ID="EDescriptionTextBox2" runat="server" Width="376px" CssClass="l_input" Height="66px" Rows="5" TextMode="MultiLine">#</asp:TextBox>
                    <span class="style1"><strong>*</strong></span></td>
            </tr>
            <tr class="tdbg" bgcolor="#e3e3e3">
                <td align="right" height="35" class="style3">
