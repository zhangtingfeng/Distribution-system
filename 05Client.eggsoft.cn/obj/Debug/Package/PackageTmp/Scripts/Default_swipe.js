...
Swipe.prototype = {
    setup: function () {
        ...
        for (var c = 0; c < children.length; c++) {
            if (children[c].tagName.toLowerCase() == "form") {
                var formChildren = children[c].children;
                for (var fc = 0; fc < formChildren.length; fc++) {
                    if (formChildren[fc].tagName.toLowerCase() == "li") {
                        this.slides.push(formChildren[fc]);
                    }
                }
            }
            else {
                this.slides.push(children[c]);
            }
        }
    ...
    slide: function (index, duration, callbak) {
