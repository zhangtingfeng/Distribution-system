<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab_Order_Board_Wait_Finished.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_Finished" %>
        ...
        <asp:DataList ID="DataList1" runat="server" CellPadding="0" Width="100%"
            ...
            <ItemTemplate>
                ...
                <tr bgcolor="#FFFFFF" class="tdbg">
                    ...
                    <td height="40" width="15%" class="styleOrder">
                        <a href="javascript:void(0)" title="<%#getGetFaHuoXML(Eval("ID").ToString())%>" id="showFaHuoFloat<%#Eval("ID")%>" onclick="showFaHuoFloat(<%#Eval("ID")%>)">查看发货情况</a>
                    </td>
                </tr>

                <tr style="display: none;" bgcolor="<%#getShenMaFenXiaoColor(Eval("ID").ToString())%>" width="100%">
                    <td colspan="7" width="80%" align="center">该订单分销统计情况： <%#ShenMaFenXiaoMoney(Eval("ID").ToString())%> 
                    </td>
                </tr>
                <tr bgcolor="#eeeeee" width="100%">
                    <td colspan="7" bgcolor="<%#getColor(Eval("ID").ToString())%>" width="100%">
        ...
        <div id="div_FaHuo" style="border: solid 10px #898989; background: #fff; padding: 10px; width: 60%; z-index: 1001; position: absolute; display: none; top: 50%; text-align: center; left: 50%; margin: -200px 0 0 -400px;">
            ...
            <table width="80%" border="0" style="border: 0px solid #898989; margin: auto;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_Num" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_ToName" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                <!--
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_ToPhone" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_ToAddress" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_FromName" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_FromPhone" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_FromAddres" runat="server" CssClass="l_input"> </asp:TextBox>
                    </td>
                </tr>-->
                <tr>
				...
				<input id="ButtonFaHuo" type="button" value=" 取 消 " onclick="Show_FaHuo_No()" class="b_reset" />
                    </td>
                </tr>
            </table>
            <br />
