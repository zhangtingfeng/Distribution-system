<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab_Order_Board_Wait_UserGetGoods.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods" %>
...
<body id="mybody">
    <form id="Form1" method="post" runat="server">
                ...
                <tr>
                    ...
                    <td style="text-align: left;" class="auto-style1">
                        <input
                            ...
                            readonly="true" class="calendarFocus l_input" style="cursor: pointer" runat="server" />
                    </td>
                </tr>
        ...
        <asp:DataList ID="DataList1" runat="server" CellSpacing="0" CellPadding="0" Width="100%"
            ...
            <ItemTemplate>
                <tr bgcolor="#FFFFFF" class="tdbg">
                    ...
                    <td height="40" width="15%" class="styleOrder">
                        <%#_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods.getUserName(Eval("UserID").ToString(),Eval("ShopClient_ID").ToString())%> 编号ID:<%#Eval("ShopUserID").ToString()%></td>
                    <td height="40" width="15%" class="styleOrder">
                    ...
                    <td height="40" width="15%" class="styleOrder">
                        <a href="javascript:void(0)" title="<%#_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods.getGetFaHuoXML(Eval("ID").ToString())%>" id="showFaHuoFloat<%#Eval("ID")%>" onclick="showFaHuoFloat(<%#Eval("ID")%>)">查看发货情况</a><br />
                        <a href="javascript:void(0)" title="<%#_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods.getGetFaHuoXML(Eval("ID").ToString())%>" id="quitFaHuoFloat<%#Eval("ID")%>" onclick="quitFaHuoFloat(<%#Eval("ID")%>)">撤销发货</a><br />
                        <a href="KuaiDiQuery.aspx?OrderID=<%#Eval("ID").ToString()%>">查看物流情况</a><br />
                    </td>
                </tr>
                <tr bgcolor="#eeeeee" width="100%">
                    <td colspan="6" width="100%">
                        <!--<%#_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods.getColor(Eval("ID").ToString())%>-->
                        <asp:DataList ID='OrderDatail' EnableViewState='false' runat='server' CssClass="style100Percent" OnItemDataBound="DataList2_ItemDataBound" Width="100%">
                            ...
                            <ItemTemplate>
                                <tr bgcolor="<%#_05Client.eggsoft.cn.ClientAdmin._19tab_Order.tab_Order_Board_Wait_UserGetGoods.getColor(Eval("ID").ToString())%>">
                                   ...
                                   (详单ID:<%#(Eval("ID").ToString())%>)
                                    ...
                                    <%#Eggsoft_Public_CL.Pub.getPubMoney(Decimal.Parse(Eval("GoodPrice").ToString()))%>
                                        <%-- <a href="javascript:void(0)" title="修改金额" onclick="showMoneyFloat(<%#Eval("ID")%>,<%#Eggsoft_Public_CL.Pub.getPubMoney(Decimal.Parse(Eval("GoodPrice").ToString()))%>)">
									修改金额</a>--%>
                                    </td>
                                    <td height="22" width="10%">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function quitFaHuoFloat(orderID)                    //根据屏幕的大小显示两个层 
            {
                self.location = 'tab_Order_Board_Wait_UserGetGoods.aspx?QuitID=' + orderID;
            }
        ...
        <div id="div_FaHuo" style="border: solid 10px #898989; background: #fff; padding: 10px; width: 60%; z-index: 1001; position: absolute; display: none; top: 50%; text-align: center; left: 50%; margin: -200px 0 0 -400px;">
            ...
            <table width="80%" border="0" style="border: 0px solid #898989; margin: auto;">
                <tr>
                    <td style="width: 30%;">
                    <tr>
                        <td style="width: 30%;">发货公司：
                        </td>
                        <td>

                            <asp:TextBox ID="TextBox_OrderID" CssClass="styleVisibleFalse l_input" runat="server" ReadOnly="true"> </asp:TextBox>
                            <asp:TextBox ID="TextBox_Which" runat="server" CssClass="l_input" ReadOnly="true"> </asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_Num" runat="server" CssClass="l_input" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_ToName" runat="server" CssClass="l_input" ReadOnly="true"> </asp:TextBox>
                    </td>
                </tr>
                <tr class="styleVisibleFalse">
                    <td class="styleVisibleFalse" style="width: 30%;">收货人电话：
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <%-- <asp:Button ID="Button_FaHuo"
                            runat="server" Text=" 确 定 " OnClick="Button_FaHuo_Click" CssClass="b_input" />&nbsp; &nbsp; &nbsp; --%>
                        <input id="ButtonFaHuo" type="button" value=" 确 定 " onclick="Show_FaHuo_No()" class="b_reset" />
                    </td>
                </tr>
            </table>
            <br />
