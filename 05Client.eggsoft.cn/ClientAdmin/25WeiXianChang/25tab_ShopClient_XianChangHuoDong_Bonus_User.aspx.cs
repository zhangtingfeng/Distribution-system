...
{
    public partial class _25tab_ShopClient_XianChangHuoDong_Bonus_User : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        EggsoftWX.BLL.View_tab_ShopClient_XianChangHuoDong_Bonus_User bll_View_tab_ShopClient_XianChangHuoDong_Bonus_User = new EggsoftWX.BLL.View_tab_ShopClient_XianChangHuoDong_Bonus_User();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LiteralstrXianChangHuoDongBonusNumberbyShopClientID.Text = "编号为" + strXianChangHuoDongBonusNumberbyShopClientID;

                string strWhere = "XianChangHuoDongBonusNumberbyShopClientID=" + strXianChangHuoDongBonusNumberbyShopClientID + " and ShopClientID=" + strShopClientID;
                ViewState["PageIndex"] = 1;
                ViewState["PageSize"] = 20;
                ViewState["RecordCount"] = bll_View_tab_ShopClient_XianChangHuoDong_Bonus_User.ExistsCount(strWhere).ToString();
                BindAnnounce();
                ShowState();
                InitGoPage();
        ...
        private void BindAnnounce()
        {
            ...
            sql.table = "View_tab_ShopClient_XianChangHuoDong_Bonus_User";
            ...
            sql.outfields = "[ID] ,[XianChangHuoDongBonusNumberbyShopClientID]      ,[ShopClientID]      ,[GetBonusName]      ,[ContactMan]      ,[ContactPhone]      ,[NickName]      ,[UserRealName]      ,[HeadImageUrl]      ,[Subscribe]       ,[ShopUserID]      ,[UpdateTime]";
            ...
            string strSql = sql.getSQL(bll_View_tab_ShopClient_XianChangHuoDong_Bonus_User.ExistsCount(strWhere));

            gvAnnounce.DataSource = bll_View_tab_ShopClient_XianChangHuoDong_Bonus_User.SelectList(strSql);
        ...
        //    string str_ShopClient_XianChangHuoDong_BonusUserID = ((LinkButton)sender).CommandArgument;
        //    string strRedirectURL = "25tab_ShopClient_XianChangHuoDong_Bonus_User_Manage.aspx?Type=delete&ID={0}&CallBackUrl=25tab_ShopClient_XianChangHuoDong_Bonus_User.aspx*XianChangHuoDongBonusNumberbyShopClientID={1}@PageIndex={2}";
        //    strRedirectURL = String.Format(strRedirectURL, str_ShopClient_XianChangHuoDong_BonusUserID, strXianChangHuoDongBonusNumberbyShopClientID, ViewState["PageIndex"].ToString());
