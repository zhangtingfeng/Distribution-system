<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="25tab_ShopClient_XianChangHuoDong_Bonus_User.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._25WeiXianChang._25tab_ShopClient_XianChangHuoDong_Bonus_User" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>现场活动 抽奖统计</title>
...
<body>
    <form id="form1" runat="server">
        <table height="100%" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
            <tr class="title">
                <th height="35">现场活动 抽奖 中奖统计（<asp:Literal ID="LiteralstrXianChangHuoDongBonusNumberbyShopClientID" runat="server"></asp:Literal>
                    &nbsp;）</th>
            </tr>
            <tr>
                <td width="100%" valign="top" align="center" style="text-align: center;">
                    <asp:GridView ID="gvAnnounce" runat="server" AllowSorting="True" AutoGenerateColumns="False" GridLines="Horizontal" BorderWidth="0px" BorderColor="#EFEFEF" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GetBonusName" HeaderText="中奖奖项">
                                <HeaderStyle Width="10%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
