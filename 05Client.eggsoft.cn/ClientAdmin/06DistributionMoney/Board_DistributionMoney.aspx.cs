...
{
    public partial class Board_DistributionMoney : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ViewState["RecordCount"] = bll.ExistsCount("ShopClientID=" + strShopClientID);
                BindAnnounce();
                ShowState();
                InitGoPage();
        ...
        private void BindAnnounce()
        {
            ...
            gvAnnounce.DataSource = bll.GetPageDataTable(Int32.Parse(ViewState["PageIndex"].ToString()), Int32.Parse(ViewState["PageSize"].ToString()), "ID,Name,Partner,Partner1,Partner2,ShopGet,OperateMan,UpdateTime", "ShopClientID=" + strShopClientID, "ID", true);
            gvAnnounce.DataBind();
        }
        ...
        protected void gvAnnounce_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                e.Row.Cells[6].Text = "<a href=\"DistributionMoney_Manage.aspx?type=Modify&ID=" + e.Row.Cells[0].Text + "\">修改</a>";
                e.Row.Cells[7].Text = "<a href=\"DistributionMoney_Manage.aspx?type=Delete&ID=" + e.Row.Cells[0].Text + "\" onclick=\"return confirm('确定删除吗?')\">删除</a>";
            }
        }
        ...
        {
            Response.Redirect("DistributionMoney_Manage.aspx?type=Add");
        }
    }
}