...
{
    public partial class _07User_WealthStatus : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string strwhere = "UserID=" + Request.QueryString["UserID"] + " and ShopClient_ID=" + strShopClientID;
        ...
        private void BindAnnounce()
        {
            ...
            sql.addOrderField("view20171001001.id", "desc");//第一排序字段  
            sql.table = "b006_TotalWealth_OperationUser";
            sql.table = @"
            (SELECT b008_OpterationUserActiveReturnMoneyOrderNum.PayDateTime, b008_OpterationUserActiveReturnMoneyOrderNum.OrderCount, 
...
FROM b006_TotalWealth_OperationUser LEFT OUTER JOIN
      ...
      b006_TotalWealth_OperationUser.ShopClient_ID = b008_OpterationUserActiveReturnMoneyOrderNum.ShopClient_ID
       AND
      b006_TotalWealth_OperationUser.UserID = b008_OpterationUserActiveReturnMoneyOrderNum.UserID where b006_TotalWealth_OperationUser.userid = "+ Request.QueryString["UserID"]+@") view20171001001";

            sql.outfields = @" [ID],PayDateTime,OrderCount,OrderDetailID
      ,[UserID]
      ,[ShopClient_ID]
      ,[UpdateTime]
      ...
      ,[CreatTime]";
        ...
        protected void gvAnnounce_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string strOrderCount = e.Row.Cells[2].Text;
                if (strOrderCount.toInt32() == 0) {
                    e.Row.Cells[4].Text = "";
                }
