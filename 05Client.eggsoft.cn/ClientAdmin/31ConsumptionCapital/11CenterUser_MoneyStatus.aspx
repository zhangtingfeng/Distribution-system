<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="11CenterUser_MoneyStatus.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._31ConsumptionCapital._11CenterUser_MoneyStatus" %>
                ...
                <td width="100%" valign="top" align="center" style="text-align: center;">
                    <asp:GridView ID="gvAnnounce" runat="server" AllowSorting="True" AutoGenerateColumns="False" GridLines="Horizontal" BorderWidth="0px" BorderColor="#EFEFEF" CellPadding="0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ConsumeOrRechargeMoney" HeaderText="发生金额" DataFormatString="{0:C}">
