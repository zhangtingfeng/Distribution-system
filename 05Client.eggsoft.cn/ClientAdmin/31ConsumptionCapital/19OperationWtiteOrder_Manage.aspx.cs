...
{
    public partial class _19OperationWtiteOrder_Manage : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(!IsPostBack)
            {
                ...
                if(type.ToLower() == "delete")
                {
                    ...
                    EggsoftWX.BLL.b013_WriteOrderByOperation bll = new EggsoftWX.BLL.b013_WriteOrderByOperation();
                    EggsoftWX.Model.b013_WriteOrderByOperation Model = bll.GetModel("ID=@ID", strID.toInt32());
                    Model.IsDeleted = 1;
                    ...
                    sendMessage(strID, type.ToLower());
                    #region 消除处理消息
                    strwebuy8_ClientAdmin_Users_ClientUserAccount = Eggsoft.Common.Session.Read("webuy8_ClientAdmin_Users_ClientUserAccount");
                    EggsoftWX.BLL.b011_InfoAlertMessage bll_b011_InfoAlertMessage = new EggsoftWX.BLL.b011_InfoAlertMessage();
                    EggsoftWX.Model.b011_InfoAlertMessage Model_b011_InfoAlertMessage = bll_b011_InfoAlertMessage.GetModel("Type='Info_b013_WriteOrderByOperation' and TypeTableID=" + strID + "");
                ...
                else if(type.ToLower() == "reject")
                {
                    ...
                    JsUtil.ShowMsg("拒绝成功!", strPubBoard);
                }

            }
        }

        private void sendMessage(string strID, string strType)
        {
            EggsoftWX.BLL.b013_WriteOrderByOperation bll_b013_WriteOrderByOperation = new EggsoftWX.BLL.b013_WriteOrderByOperation();
            EggsoftWX.Model.b013_WriteOrderByOperation Model_b013_WriteOrderByOperation = bll_b013_WriteOrderByOperation.GetModel(strID.toInt32());
            ...
            string strTitle = strUserNickName + "你好。你的运营中心下单:已被" + strMessage + "\n";
            ...
            EggsoftWX.Model.tab_ShopClient my_Model_tab_ShopClient = my_BLL_tab_ShopClient.GetModel(Convert.ToInt32(strShopClientID));
            ...
            if(string.IsNullOrWhiteSpace(strTo) == false)
            {
                ...
                strBody += strUserNickName + "你好。你的运营中心下单:已被" + strMessage + "\n";
                strTitle += "下单人ID：" + Model_b013_WriteOrderByOperation.BuyOrderShopUserID + "\n";
                strTitle += "上级ID:" + Model_b013_WriteOrderByOperation.BuyParentShopUserID + "\n";
                strTitle += "支付流水号:" + Model_b013_WriteOrderByOperation.PaySerialNumber + "\n";
        ...
        //            strwebuy8_ClientAdmin_Users_ClientUserAccount = Eggsoft.Common.Session.Read("webuy8_ClientAdmin_Users_ClientUserAccount");
        //            EggsoftWX.BLL.b011_InfoAlertMessage bll_b011_InfoAlertMessage = new EggsoftWX.BLL.b011_InfoAlertMessage();
        //            EggsoftWX.Model.b011_InfoAlertMessage Model_b011_InfoAlertMessage = bll_b011_InfoAlertMessage.GetModel("Type='b010_AskModifyParent' and TypeTableID=" + TypeTableID + "");
        //            if(Model_b011_InfoAlertMessage != null)
        //            {
        //                Model_b011_InfoAlertMessage.Done = true;
        //                Model_b011_InfoAlertMessage.UpdateBy = strwebuy8_ClientAdmin_Users_ClientUserAccount;
