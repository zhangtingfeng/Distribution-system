...
{
    public partial class FenXiaoLevel_Board : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                int intExistsCount = bll.ExistsCount("ShopClient_ID=" + str_Pub_ShopClientID);
        ...
        private void BindAnnounce()
        {
            ...
            sql.addOrderField("tab_ShopClient_FenXiaoLevel.sort", "asc");//第一排序字段  
            sql.addOrderField("tab_ShopClient_FenXiaoLevel.id", "asc");//第二排序字段  
            sql.table = "tab_ShopClient_FenXiaoLevel";
            sql.outfields = "[ID]      ,[ShopClient_ID]      ,[Name]      ,[Sort]      ,[UpdateTime]      ,[LevelPercent]";
        ...
        protected void gvAnnounce_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[5].Text = "<a href=\"FenXiaoLevel_Manage.aspx?type=Modify&ID=" + e.Row.Cells[0].Text + "\">修改</a>";
                e.Row.Cells[6].Text = "<a href=\"FenXiaoLevel_Manage.aspx?type=Delete&ID=" + e.Row.Cells[0].Text + "\" onclick=\"return confirm('确定删除吗?')\">删除</a>";
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("FenXiaoLevel_Manage.aspx?type=Add");
            }
        }
