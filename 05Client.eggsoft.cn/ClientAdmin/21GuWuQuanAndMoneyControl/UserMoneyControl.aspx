<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserMoneyControl.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._21GuWuQuanAndMoneyControl.UserMoneyControl" %>
...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var ctrl = document.getElementById("TextBox_ShopUserID");
        ...
        function timedMsg() {
            console.log("11");
            var ctrl = document.getElementById("TextBox_ShopUserID");
            var cardNmbr = ctrl.value;
            if (cardNmbr.length > 10) {
                var btnChaXun = document.getElementById("btnChaXun");
                btnChaXun.onclick();
            }
            else {
                    ...
                    <asp:Panel ID="Panel_UserInfo" runat="server" Visible="false">
                        ...
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            ...
                            <td width="80%" height="35" bgcolor="#ecf5ff">
                                ...
                                <asp:HyperLink ID="HyperLink_UserInfo_GouWuQuan" runat="server">HyperLink</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                   <asp:HyperLink ID="HyperLink_UserInfo_Money" runat="server">HyperLink</asp:HyperLink>
                            </td>
                        </tr>
                        ...
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            ...
                            <td width="80%" height="35" bgcolor="#ecf5ff">
                                <asp:TextBox ID="TextBox_AddMoney" runat="server"></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="充值金额不能为空!"
                                    ControlToValidate="TextBox_AddMoney" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                                请仔细核对微信昵称和用户编号。微信昵称可能出现类似和重名。本平台充值的唯一条件是用户编号
                            </td>
                        </tr>
                        <tr class="tdbg" bgcolor="#e3e3e3">
                            <td align="right">
