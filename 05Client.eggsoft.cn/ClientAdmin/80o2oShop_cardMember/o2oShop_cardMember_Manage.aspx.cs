...
{
    public partial class o2oShop_cardMember_Manage : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (type.ToLower() == "delete")
                {
                    ...
                    EggsoftWX.Model.b080_Shop_cardMemberPic Model = bll.GetModel(Int32.Parse(ID));//删除文件
                    Eggsoft.Common.FileFolder.DeleteFile(Server.MapPath(Model.PicUrl));//删除文件

                    bll.Delete(Int32.Parse(ID));
                    JsUtil.ShowMsg("删除成功!", "Board80o2oShop_cardMember.aspx");
                }
        ...
        private void SetClass()
        {
            ...
            if (type.ToLower() == "modify")
            {
                ...
                EggsoftWX.BLL.b080_Shop_cardMemberPic bll = new EggsoftWX.BLL.b080_Shop_cardMemberPic();
                EggsoftWX.Model.b080_Shop_cardMemberPic Model = bll.GetModel(Int32.Parse(ID));

                txtTitle.Text = Model.ShowText;
                Link0.Text = Model.LinkURL;
                CDescriptionTextBox1.Text = Model.Arg1;
                EDescriptionTextBox2.Text = Model.Arg2;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (type.ToLower() == "modify")
            {
                ...
                Model.Arg1 = CDescriptionTextBox1.Text;
                Model.Arg2 = EDescriptionTextBox2.Text;


                Model.Pos = intpos;
                bll.Update(Model);
                JsUtil.ShowMsg("修改成功!", "Board80o2oShop_cardMember.aspx");
            ...
            {
                EggsoftWX.BLL.b080_Shop_cardMemberPic bll = new EggsoftWX.BLL.b080_Shop_cardMemberPic();
                EggsoftWX.Model.b080_Shop_cardMemberPic Announce = new EggsoftWX.Model.b080_Shop_cardMemberPic();
                ...
                Announce.Pos = intpos;
                Announce.Arg1 = CDescriptionTextBox1.Text;
                Announce.Arg2 = EDescriptionTextBox2.Text;


               
                bll.Add(Announce);
                JsUtil.ShowMsg("添加成功!", "Board80o2oShop_cardMember.aspx");
