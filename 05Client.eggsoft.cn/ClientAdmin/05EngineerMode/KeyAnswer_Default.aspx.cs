...
{
    public partial class KeyAnswer_Default : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        {
            #region 没有的权限
            if (!String.IsNullOrEmpty(Eggsoft_Public_CL.PubMember.DisPlayPower("Devolopment_KeyAnswer_Default")))
            {
        ...
        protected void IniReadContent()
        {
            ...
            myTextBox.Text = Model_tab_ShopClient_EngineerMode.KeyAnswer_Default;
        ...
        protected void Button_Save_Click(object sender, EventArgs e)
        {
            ...
            EggsoftWX.BLL.tab_ShopClient_EngineerMode BLL_tab_ShopClient_EngineerMode = new EggsoftWX.BLL.tab_ShopClient_EngineerMode();
            EggsoftWX.Model.tab_ShopClient_EngineerMode Model_tab_ShopClient_EngineerMode = BLL_tab_ShopClient_EngineerMode.GetModel("ShopClientID=" + strShopClientID);
            Model_tab_ShopClient_EngineerMode.KeyAnswer_Default = myTextBox.Text;
