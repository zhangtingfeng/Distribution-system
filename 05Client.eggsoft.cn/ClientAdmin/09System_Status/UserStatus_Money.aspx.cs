...
{
    public partial class UserStatus_Money : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ViewState["RecordCount"] = bll_tab_TotalCredits_Consume_Or_Recharge.ExistsCount(strUserID).ToString();
                BindAnnounce();
                ShowState();
                InitGoPage();
        ...
        private void BindAnnounce()
        {
            ...
            sql.addOrderField("tab_TotalCredits_Consume_Or_Recharge.id", "desc");//第一排序字段  
            sql.table = "tab_TotalCredits_Consume_Or_Recharge";
            sql.outfields = "tab_TotalCredits_Consume_Or_Recharge.ID,tab_TotalCredits_Consume_Or_Recharge.UpdateTime,tab_TotalCredits_Consume_Or_Recharge.ConsumeOrRechargeMoney,tab_TotalCredits_Consume_Or_Recharge.ConsumeTypeOrRecharge,tab_TotalCredits_Consume_Or_Recharge.RemainingSum,tab_TotalCredits_Consume_Or_Recharge.Bool_ConsumeOrRecharge";
            ...
            string strSql = sql.getSQL(bll_tab_TotalCredits_Consume_Or_Recharge.ExistsCount(strwhere));

            gvAnnounce.DataSource = bll_tab_TotalCredits_Consume_Or_Recharge.SelectList(strSql);
