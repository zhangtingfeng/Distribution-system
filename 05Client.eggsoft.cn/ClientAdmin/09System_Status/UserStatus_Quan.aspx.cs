...
{
    public partial class UserStatus_Quan : Eggsoft.Common.DotAdminPage_ClientAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ViewState["RecordCount"] = bll_tab_Total_Vouchers_Consume_Or_Recharge.ExistsCount(strUserID).ToString();
                BindAnnounce();
                ShowState();
                InitGoPage();
        ...
        private void BindAnnounce()
        {
            ...
            sql.addOrderField("tab_Total_Vouchers_Consume_Or_Recharge.id", "desc");//第一排序字段  
            sql.table = "tab_Total_Vouchers_Consume_Or_Recharge";
            sql.outfields = "tab_Total_Vouchers_Consume_Or_Recharge.ID,tab_Total_Vouchers_Consume_Or_Recharge.UpdateTime,tab_Total_Vouchers_Consume_Or_Recharge.ConsumeOrRecharge_Vouchers,tab_Total_Vouchers_Consume_Or_Recharge.ConsumeTypeOrRecharge,tab_Total_Vouchers_Consume_Or_Recharge.RemainingSum_Vouchers,tab_Total_Vouchers_Consume_Or_Recharge.Bool_ConsumeOrRecharge";
            ...
            string strSql = sql.getSQL(bll_tab_Total_Vouchers_Consume_Or_Recharge.ExistsCount(strwhere));

            gvAnnounce.DataSource = bll_tab_Total_Vouchers_Consume_Or_Recharge.SelectList(strSql);
