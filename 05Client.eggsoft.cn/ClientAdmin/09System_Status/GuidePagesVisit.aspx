<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidePagesVisit.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._09System_Status.GuidePagesVisit" %>
			...
			<asp:GridView ID="gvAnnounce" runat="server" AllowSorting="True" AutoGenerateColumns="False" GridLines="Horizontal" BorderWidth="0" BorderColor="#EFEFEF" CellSpacing="0" CellPadding="0"
				...
				<Columns>
					...
					<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
					 ...
					 <asp:BoundField DataField="GuidePagesID" HeaderText="咨询编号">
					<HeaderStyle Width="8%" />
					<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
					</asp:BoundField>
					
					<asp:BoundField DataField="MenuName" HeaderText="咨询名称">
