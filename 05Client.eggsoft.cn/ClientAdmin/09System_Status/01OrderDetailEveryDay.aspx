<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01OrderDetailEveryDay.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._31ConsumptionCapital.__01OrderDetailEveryDay" %>
        ...
        <div class="mselct">
            <table style="width: 90%;">
                <tr>
                    ...
                    <td style="text-align: right;">团队ID:</td>
                    <td style="text-align: left;">
                        <asp:TextBox ID="TextTeamIDName" runat="server" Width="114px"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        <asp:TextBox ID="TextBox_GoodID" runat="server" Width="114px"></asp:TextBox></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="text-align: left;" class="auto-style1">
                ...
                <td width="100%" valign="top" align="center">
                    <span class="floatLeft">页面金额统计： 
                        <asp:Label ID="LabelPageMoney" runat="server" Text=""></asp:Label>/<asp:Label ID="LabelPagesAllMoney" runat="server" Text=""></asp:Label>
                          不含运费 <asp:Label ID="LabelPageMoneyNotYunFei" runat="server" Text=""></asp:Label>/<asp:Label ID="LabelPagesAllMoneyNotYunFei" runat="server" Text=""></asp:Label>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="tab_OrderCreatTime" HeaderText="订单创建时间">
                             ...
                             <asp:BoundField DataField="GoodName" HeaderText="商品名称">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="ChangeLine"  />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="PaywayOrderNum" HeaderText="支付流水号">
                                <ControlStyle CssClass="ChangeLine" />
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="ChangeLine" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="ShopName" HeaderText="团队">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ShopTeamID" HeaderText="团队ID">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                          ...
                          <%--  <asp:BoundField DataField="GrandParentMasterName" HeaderText="上级团队">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>--%>

                          <%--  <asp:BoundField DataField="ParentOperationCenterID" HeaderText="上级团队ID">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>--%>
                            ...
                            <asp:CheckBoxField DataField="Over7DaysToBeans" HeaderText="是否转化">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:CheckBoxField>
                   ...
                   <asp:LinkButton ID="lbtnFirst" runat="server" OnClick="lbtnFirst_Click">首页</asp:LinkButton>
                    ...
                    <span class="floatLeft">
                        ...
                        <asp:LinkButton ID="LinkButton_DownLoad" runat="server" OnClick="lbtnLast_Click_DownLoad" Visible="False">表格全部数据下载</asp:LinkButton>
