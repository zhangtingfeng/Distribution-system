<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_ModifyParent.aspx.cs" Inherits="_05Client.eggsoft.cn.ClientAdmin._09System_Status.User_ModifyParent" %>
                        ...
                        <table class="borderClass" style="width: 100%; height: 107px" cellspacing="2" cellpadding="0" align="center" border="0">
                            ...
                            <tr class="tdbg" bgcolor="#c0c0c0">
                                <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                    <div align="right"><strong>上级微店号：</strong></div>
                                </td>
                                <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                    <div align="left" style="margin-right: 100px;">
                                        <asp:TextBox ID="TextBox_PaerntID_ShopUserD" runat="server" AutoPostBack="True" OnTextChanged="TextBox_PaerntID_ShopUserD_TextChanged"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <tr class="tdbg" bgcolor="#c0c0c0">
                                        <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                            <div align="right"><strong>上级昵称：</strong></div>
                                        </td>
                                        <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                            <div align="left" style="margin-right: 100px;">
                                                 <asp:Label ID="Label1ParentNickName" runat="server" Text=""></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="tdbg" bgcolor="#c0c0c0">
                                        <td bgcolor="#e3e3e3" align="right" class="auto-style2">
                                            <div align="right"><strong>上级头像：</strong></div>
                                        </td>
                                        <td align="center" bgcolor="#ecf5ff" class="auto-style3">

                                            <div align="left" style="margin-right: 100px;">
                                                <asp:Image ID="Image1Parent" Width="40px" runat="server" />
                                            </div>
                                        </td>
                                    </tr>
